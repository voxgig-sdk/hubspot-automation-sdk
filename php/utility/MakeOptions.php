...
// HubspotAutomation SDK utility: make_options

class HubspotAutomationMakeOptions
{
    ...
    public static function call(HubspotAutomationContext $ctx): array
    {
        ...
        //
        // `HubspotAutomationSchema::optspec()` is built from the model:
        ...
        $optspec = HubspotAutomationSchema::optspec();
