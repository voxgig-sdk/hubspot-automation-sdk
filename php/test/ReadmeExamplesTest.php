...
// HubspotAutomation SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (HubspotAutomationSDK::test)
...
{
    private const SDK_CLASS = 'HubspotAutomationSDK';
    ...
    private const SDK_BASE = 'hubspotautomation_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../hubspotautomation_sdk.php';
