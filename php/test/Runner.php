...
class HubspotAutomationTestRunner
{
    ...
    {
        $live = self::getenv('HUBSPOT_AUTOMATION_TEST_LIVE');
        $override = self::getenv('HUBSPOT_AUTOMATION_TEST_OVERRIDE');
        ...
        $explain = self::getenv('HUBSPOT_AUTOMATION_TEST_EXPLAIN');
...
class_alias('HubspotAutomationTestRunner', 'Runner');
class_alias('HubspotAutomationHelpers', 'Helpers');
