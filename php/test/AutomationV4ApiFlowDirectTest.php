...
// AutomationV4ApiFlow direct test
...
class AutomationV4ApiFlowDirectTest extends TestCase
{
    public function test_direct_load_automation_v4_api_flow(): void
    {
        $setup = automation_v4_api_flow_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-automation_v4_api_flow", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
...
function automation_v4_api_flow_direct_setup($mockres)
{
