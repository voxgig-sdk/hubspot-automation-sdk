...
class ActionsV4CollectionResponsePublicActionRevisionForwardDirectTest extends TestCase
{
    public function test_direct_list_actions_v4_collection_response_public_action_revision_forward(): void
    {
        $setup = actions_v4_collection_response_public_action_revision_forward_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-actions_v4_collection_response_public_action_revision_forward", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
...
function actions_v4_collection_response_public_action_revision_forward_direct_setup($mockres)
{
