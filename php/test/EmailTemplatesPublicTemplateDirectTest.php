...
// EmailTemplatesPublicTemplate direct test
...
class EmailTemplatesPublicTemplateDirectTest extends TestCase
{
    public function test_direct_load_email_templates_public_template(): void
    {
        $setup = email_templates_public_template_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-email_templates_public_template", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
...
function email_templates_public_template_direct_setup($mockres)
{
