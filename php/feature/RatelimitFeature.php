...
// HubspotAutomation SDK ratelimit feature
...
class HubspotAutomationRatelimitFeature extends HubspotAutomationBaseFeature
{
    ...
    private function _acquire(HubspotAutomationContext $ctx): void
    {
    ...
    private function _track(HubspotAutomationContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
