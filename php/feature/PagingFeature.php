...
// HubspotAutomation SDK paging feature
...
class HubspotAutomationPagingFeature extends HubspotAutomationBaseFeature
{
    ...
    private function _graphql_pre_request(HubspotAutomationContext $ctx, array $paging): void
    {
        $body = $ctx->spec->body;
        if (!is_array($body)) {
            return;
    ...
    private function _is_list(HubspotAutomationContext $ctx): bool
    {
