...
class ActionsV4PublicActionDefinitionRequiresObjectEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "actions_v4_public_action_definition_requires_object";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ActionsV4PublicActionDefinitionRequiresObjectEntity($this->_client, $opts);
    }

    /**
     * @param ActionsV4PublicActionDefinitionRequiresObject|array $args ActionsV4PublicActionDefinitionRequiresObject data (assoc-array) to store.
     */
    ...
    /**
     * @return ActionsV4PublicActionDefinitionRequiresObject|array The current ActionsV4PublicActionDefinitionRequiresObject data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ActionsV4PublicActionDefinitionRequiresObject fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ActionsV4PublicActionDefinitionRequiresObject fields).
     */
    ...
    /**
     * Load a single ActionsV4PublicActionDefinitionRequiresObject.
     *
     * @param ActionsV4PublicActionDefinitionRequiresObjectLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ActionsV4PublicActionDefinitionRequiresObjectLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ActionsV4PublicActionDefinitionRequiresObject|array The loaded ActionsV4PublicActionDefinitionRequiresObject as an assoc-array at the
