...
class ActionsV4PublicActionFunctionIdentifierEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "actions_v4_public_action_function_identifier";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ActionsV4PublicActionFunctionIdentifierEntity($this->_client, $opts);
    }

    /**
     * @param ActionsV4PublicActionFunctionIdentifier|array $args ActionsV4PublicActionFunctionIdentifier data (assoc-array) to store.
     */
    ...
    /**
     * @return ActionsV4PublicActionFunctionIdentifier|array The current ActionsV4PublicActionFunctionIdentifier data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ActionsV4PublicActionFunctionIdentifier fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ActionsV4PublicActionFunctionIdentifier fields).
     */
    ...
    /**
     * Update an existing ActionsV4PublicActionFunctionIdentifier.
     *
     * @param ActionsV4PublicActionFunctionIdentifierUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ActionsV4PublicActionFunctionIdentifierUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ActionsV4PublicActionFunctionIdentifier|array The updated ActionsV4PublicActionFunctionIdentifier as an assoc-array at the
