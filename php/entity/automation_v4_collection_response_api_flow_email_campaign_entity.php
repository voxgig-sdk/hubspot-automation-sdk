...
class AutomationV4CollectionResponseApiFlowEmailCampaignEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "automation_v4_collection_response_api_flow_email_campaign";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new AutomationV4CollectionResponseApiFlowEmailCampaignEntity($this->_client, $opts);
    }

    /**
     * @param AutomationV4CollectionResponseApiFlowEmailCampaign|array $args AutomationV4CollectionResponseApiFlowEmailCampaign data (assoc-array) to store.
     */
    ...
    /**
     * @return AutomationV4CollectionResponseApiFlowEmailCampaign|array The current AutomationV4CollectionResponseApiFlowEmailCampaign data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of AutomationV4CollectionResponseApiFlowEmailCampaign fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of AutomationV4CollectionResponseApiFlowEmailCampaign fields).
     */
    ...
    /**
     * List AutomationV4CollectionResponseApiFlowEmailCampaign items matching the given filter.
     *
     * @param AutomationV4CollectionResponseApiFlowEmailCampaignListMatch|array|null $reqmatch Match filter (any subset
     *   of AutomationV4CollectionResponseApiFlowEmailCampaign fields) as an assoc-array; AutomationV4CollectionResponseApiFlowEmailCampaignListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return AutomationV4CollectionResponseApiFlowEmailCampaign[]|array A list of AutomationV4CollectionResponseApiFlowEmailCampaign items as assoc-arrays at
