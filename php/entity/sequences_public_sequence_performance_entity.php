...
class SequencesPublicSequencePerformanceEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "sequences_public_sequence_performance";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new SequencesPublicSequencePerformanceEntity($this->_client, $opts);
    }

    /**
     * @param SequencesPublicSequencePerformance|array $args SequencesPublicSequencePerformance data (assoc-array) to store.
     */
    ...
    /**
     * @return SequencesPublicSequencePerformance|array The current SequencesPublicSequencePerformance data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of SequencesPublicSequencePerformance fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of SequencesPublicSequencePerformance fields).
     */
    ...
    /**
     * List SequencesPublicSequencePerformance items matching the given filter.
     *
     * @param SequencesPublicSequencePerformanceListMatch|array|null $reqmatch Match filter (any subset
     *   of SequencesPublicSequencePerformance fields) as an assoc-array; SequencesPublicSequencePerformanceListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return SequencesPublicSequencePerformance[]|array A list of SequencesPublicSequencePerformance items as assoc-arrays at
