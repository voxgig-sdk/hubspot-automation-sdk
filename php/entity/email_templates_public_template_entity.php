...
// HubspotAutomation SDK EmailTemplatesPublicTemplate entity
...
class EmailTemplatesPublicTemplateEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "email_templates_public_template";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new EmailTemplatesPublicTemplateEntity($this->_client, $opts);
    }

    /**
     * @param EmailTemplatesPublicTemplate|array $args EmailTemplatesPublicTemplate data (assoc-array) to store.
     */
    ...
    /**
     * @return EmailTemplatesPublicTemplate|array The current EmailTemplatesPublicTemplate data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of EmailTemplatesPublicTemplate fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of EmailTemplatesPublicTemplate fields).
     */
    ...
    /**
     * Load a single EmailTemplatesPublicTemplate.
     *
     * @param EmailTemplatesPublicTemplateLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed EmailTemplatesPublicTemplateLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return EmailTemplatesPublicTemplate|array The loaded EmailTemplatesPublicTemplate as an assoc-array at the
    ...
    /**
     * Create a new EmailTemplatesPublicTemplate.
     *
     * @param EmailTemplatesPublicTemplateCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed EmailTemplatesPublicTemplateCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return EmailTemplatesPublicTemplate|array The created EmailTemplatesPublicTemplate as an assoc-array at the
     *   SDK boundary; throws HubspotAutomationError on failure (item-5 convention).
     */
    ...
    /**
     * Update an existing EmailTemplatesPublicTemplate.
     *
     * @param EmailTemplatesPublicTemplateUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed EmailTemplatesPublicTemplateUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return EmailTemplatesPublicTemplate|array The updated EmailTemplatesPublicTemplate as an assoc-array at the
     *   SDK boundary; throws HubspotAutomationError on failure (item-5 convention).
     */
