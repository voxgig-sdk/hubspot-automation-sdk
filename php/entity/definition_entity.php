...
// HubspotAutomation SDK Definition entity
...
class DefinitionEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new DefinitionEntity($this->_client, $opts);
    }

    /**
     * @param Definition|array $args Definition data (assoc-array) to store.
     */
    ...
    /**
     * @return Definition|array The current Definition data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Definition fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Definition fields).
     */
     ...
     *
     * @param DefinitionCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed DefinitionCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Definition|array The created Definition as an assoc-array at the
    ...
    /**
     * Remove an Definition matching the given criteria.
     *
     * @param DefinitionRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; DefinitionRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Definition|array The removed Definition as an assoc-array at the
     *   SDK boundary; throws HubspotAutomationError on failure (item-5 convention).
     */
