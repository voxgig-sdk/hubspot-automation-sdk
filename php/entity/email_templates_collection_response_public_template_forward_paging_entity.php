...
class EmailTemplatesCollectionResponsePublicTemplateForwardPagingEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "email_templates_collection_response_public_template_forward_paging";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new EmailTemplatesCollectionResponsePublicTemplateForwardPagingEntity($this->_client, $opts);
    }

    /**
     * @param EmailTemplatesCollectionResponsePublicTemplateForwardPaging|array $args EmailTemplatesCollectionResponsePublicTemplateForwardPaging data (assoc-array) to store.
     */
    ...
    /**
     * @return EmailTemplatesCollectionResponsePublicTemplateForwardPaging|array The current EmailTemplatesCollectionResponsePublicTemplateForwardPaging data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of EmailTemplatesCollectionResponsePublicTemplateForwardPaging fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of EmailTemplatesCollectionResponsePublicTemplateForwardPaging fields).
     */
    ...
    /**
     * List EmailTemplatesCollectionResponsePublicTemplateForwardPaging items matching the given filter.
     *
     * @param EmailTemplatesCollectionResponsePublicTemplateForwardPagingListMatch|array|null $reqmatch Match filter (any subset
     *   of EmailTemplatesCollectionResponsePublicTemplateForwardPaging fields) as an assoc-array; EmailTemplatesCollectionResponsePublicTemplateForwardPagingListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return EmailTemplatesCollectionResponsePublicTemplateForwardPaging[]|array A list of EmailTemplatesCollectionResponsePublicTemplateForwardPaging items as assoc-arrays at
