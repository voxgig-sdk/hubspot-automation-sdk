...
// HubspotAutomation SDK Function entity
...
class FunctionEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new FunctionEntity($this->_client, $opts);
    }

    /**
     * @param Function|array $args Function data (assoc-array) to store.
     */
    ...
    /**
     * @return Function|array The current Function data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Function fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Function fields).
     */
    ...
    /**
     * Remove an Function matching the given criteria.
     *
     * @param FunctionRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; FunctionRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Function|array The removed Function as an assoc-array at the
