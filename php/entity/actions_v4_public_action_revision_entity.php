...
// HubspotAutomation SDK ActionsV4PublicActionRevision entity
...
class ActionsV4PublicActionRevisionEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "actions_v4_public_action_revision";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ActionsV4PublicActionRevisionEntity($this->_client, $opts);
    }

    /**
     * @param ActionsV4PublicActionRevision|array $args ActionsV4PublicActionRevision data (assoc-array) to store.
     */
    ...
    /**
     * @return ActionsV4PublicActionRevision|array The current ActionsV4PublicActionRevision data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ActionsV4PublicActionRevision fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ActionsV4PublicActionRevision fields).
     */
    ...
    /**
     * Load a single ActionsV4PublicActionRevision.
     *
     * @param ActionsV4PublicActionRevisionLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ActionsV4PublicActionRevisionLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ActionsV4PublicActionRevision|array The loaded ActionsV4PublicActionRevision as an assoc-array at the
