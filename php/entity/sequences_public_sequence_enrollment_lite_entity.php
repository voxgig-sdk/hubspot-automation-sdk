...
class SequencesPublicSequenceEnrollmentLiteEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "sequences_public_sequence_enrollment_lite";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new SequencesPublicSequenceEnrollmentLiteEntity($this->_client, $opts);
    }

    /**
     * @param SequencesPublicSequenceEnrollmentLite|array $args SequencesPublicSequenceEnrollmentLite data (assoc-array) to store.
     */
    ...
    /**
     * @return SequencesPublicSequenceEnrollmentLite|array The current SequencesPublicSequenceEnrollmentLite data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of SequencesPublicSequenceEnrollmentLite fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of SequencesPublicSequenceEnrollmentLite fields).
     */
    ...
    /**
     * Create a new SequencesPublicSequenceEnrollmentLite.
     *
     * @param SequencesPublicSequenceEnrollmentLiteCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed SequencesPublicSequenceEnrollmentLiteCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return SequencesPublicSequenceEnrollmentLite|array The created SequencesPublicSequenceEnrollmentLite as an assoc-array at the
