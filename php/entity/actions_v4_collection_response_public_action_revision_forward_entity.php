...
class ActionsV4CollectionResponsePublicActionRevisionForwardEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "actions_v4_collection_response_public_action_revision_forward";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ActionsV4CollectionResponsePublicActionRevisionForwardEntity($this->_client, $opts);
    }

    /**
     * @param ActionsV4CollectionResponsePublicActionRevisionForward|array $args ActionsV4CollectionResponsePublicActionRevisionForward data (assoc-array) to store.
     */
    ...
    /**
     * @return ActionsV4CollectionResponsePublicActionRevisionForward|array The current ActionsV4CollectionResponsePublicActionRevisionForward data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ActionsV4CollectionResponsePublicActionRevisionForward fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ActionsV4CollectionResponsePublicActionRevisionForward fields).
     */
    ...
    /**
     * List ActionsV4CollectionResponsePublicActionRevisionForward items matching the given filter.
     *
     * @param ActionsV4CollectionResponsePublicActionRevisionForwardListMatch|array|null $reqmatch Match filter (any subset
     *   of ActionsV4CollectionResponsePublicActionRevisionForward fields) as an assoc-array; ActionsV4CollectionResponsePublicActionRevisionForwardListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ActionsV4CollectionResponsePublicActionRevisionForward[]|array A list of ActionsV4CollectionResponsePublicActionRevisionForward items as assoc-arrays at
