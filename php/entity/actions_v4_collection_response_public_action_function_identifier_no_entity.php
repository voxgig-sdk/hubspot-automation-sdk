...
class ActionsV4CollectionResponsePublicActionFunctionIdentifierNoEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "actions_v4_collection_response_public_action_function_identifier_no";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ActionsV4CollectionResponsePublicActionFunctionIdentifierNoEntity($this->_client, $opts);
    }

    /**
     * @param ActionsV4CollectionResponsePublicActionFunctionIdentifierNo|array $args ActionsV4CollectionResponsePublicActionFunctionIdentifierNo data (assoc-array) to store.
     */
    ...
    /**
     * @return ActionsV4CollectionResponsePublicActionFunctionIdentifierNo|array The current ActionsV4CollectionResponsePublicActionFunctionIdentifierNo data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ActionsV4CollectionResponsePublicActionFunctionIdentifierNo fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ActionsV4CollectionResponsePublicActionFunctionIdentifierNo fields).
     */
    ...
    /**
     * List ActionsV4CollectionResponsePublicActionFunctionIdentifierNo items matching the given filter.
     *
     * @param ActionsV4CollectionResponsePublicActionFunctionIdentifierNoListMatch|array|null $reqmatch Match filter (any subset
     *   of ActionsV4CollectionResponsePublicActionFunctionIdentifierNo fields) as an assoc-array; ActionsV4CollectionResponsePublicActionFunctionIdentifierNoListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ActionsV4CollectionResponsePublicActionFunctionIdentifierNo[]|array A list of ActionsV4CollectionResponsePublicActionFunctionIdentifierNo items as assoc-arrays at
     *   the SDK boundary; throws HubspotAutomationError on failure (item-5 convention).
     */
