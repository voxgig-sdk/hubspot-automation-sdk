...
// HubspotAutomation SDK ActionsV4PublicActionFunction entity
...
class ActionsV4PublicActionFunctionEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "actions_v4_public_action_function";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ActionsV4PublicActionFunctionEntity($this->_client, $opts);
    }

    /**
     * @param ActionsV4PublicActionFunction|array $args ActionsV4PublicActionFunction data (assoc-array) to store.
     */
    ...
    /**
     * @return ActionsV4PublicActionFunction|array The current ActionsV4PublicActionFunction data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ActionsV4PublicActionFunction fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ActionsV4PublicActionFunction fields).
     */
    ...
    /**
     * Load a single ActionsV4PublicActionFunction.
     *
     * @param ActionsV4PublicActionFunctionLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ActionsV4PublicActionFunctionLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ActionsV4PublicActionFunction|array The loaded ActionsV4PublicActionFunction as an assoc-array at the
