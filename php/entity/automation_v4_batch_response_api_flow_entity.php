...
class AutomationV4BatchResponseApiFlowEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "automation_v4_batch_response_api_flow";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new AutomationV4BatchResponseApiFlowEntity($this->_client, $opts);
    }

    /**
     * @param AutomationV4BatchResponseApiFlow|array $args AutomationV4BatchResponseApiFlow data (assoc-array) to store.
     */
    ...
    /**
     * @return AutomationV4BatchResponseApiFlow|array The current AutomationV4BatchResponseApiFlow data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of AutomationV4BatchResponseApiFlow fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of AutomationV4BatchResponseApiFlow fields).
     */
    ...
    /**
     * Create a new AutomationV4BatchResponseApiFlow.
     *
     * @param AutomationV4BatchResponseApiFlowCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed AutomationV4BatchResponseApiFlowCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return AutomationV4BatchResponseApiFlow|array The created AutomationV4BatchResponseApiFlow as an assoc-array at the
