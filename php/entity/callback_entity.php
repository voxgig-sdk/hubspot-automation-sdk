...
// HubspotAutomation SDK Callback entity
...
class CallbackEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new CallbackEntity($this->_client, $opts);
    }

    /**
     * @param Callback|array $args Callback data (assoc-array) to store.
     */
    ...
    /**
     * @return Callback|array The current Callback data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Callback fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Callback fields).
     */
     ...
     *
     * @param CallbackCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed CallbackCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Callback|array The created Callback as an assoc-array at the
