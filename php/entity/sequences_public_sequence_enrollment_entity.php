...
class SequencesPublicSequenceEnrollmentEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "sequences_public_sequence_enrollment";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new SequencesPublicSequenceEnrollmentEntity($this->_client, $opts);
    }

    /**
     * @param SequencesPublicSequenceEnrollment|array $args SequencesPublicSequenceEnrollment data (assoc-array) to store.
     */
    ...
    /**
     * @return SequencesPublicSequenceEnrollment|array The current SequencesPublicSequenceEnrollment data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of SequencesPublicSequenceEnrollment fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of SequencesPublicSequenceEnrollment fields).
     */
    ...
    /**
     * Load a single SequencesPublicSequenceEnrollment.
     *
     * @param SequencesPublicSequenceEnrollmentLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed SequencesPublicSequenceEnrollmentLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return SequencesPublicSequenceEnrollment|array The loaded SequencesPublicSequenceEnrollment as an assoc-array at the
