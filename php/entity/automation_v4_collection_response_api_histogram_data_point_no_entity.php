...
class AutomationV4CollectionResponseApiHistogramDataPointNoEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "automation_v4_collection_response_api_histogram_data_point_no";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new AutomationV4CollectionResponseApiHistogramDataPointNoEntity($this->_client, $opts);
    }

    /**
     * @param AutomationV4CollectionResponseApiHistogramDataPointNo|array $args AutomationV4CollectionResponseApiHistogramDataPointNo data (assoc-array) to store.
     */
    ...
    /**
     * @return AutomationV4CollectionResponseApiHistogramDataPointNo|array The current AutomationV4CollectionResponseApiHistogramDataPointNo data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of AutomationV4CollectionResponseApiHistogramDataPointNo fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of AutomationV4CollectionResponseApiHistogramDataPointNo fields).
     */
    ...
    /**
     * Load a single AutomationV4CollectionResponseApiHistogramDataPointNo.
     *
     * @param AutomationV4CollectionResponseApiHistogramDataPointNoLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed AutomationV4CollectionResponseApiHistogramDataPointNoLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return AutomationV4CollectionResponseApiHistogramDataPointNo|array The loaded AutomationV4CollectionResponseApiHistogramDataPointNo as an assoc-array at the
