...
// HubspotAutomation SDK AutomationV4ApiFlow entity
...
class AutomationV4ApiFlowEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "automation_v4_api_flow";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new AutomationV4ApiFlowEntity($this->_client, $opts);
    }

    /**
     * @param AutomationV4ApiFlow|array $args AutomationV4ApiFlow data (assoc-array) to store.
     */
    ...
    /**
     * @return AutomationV4ApiFlow|array The current AutomationV4ApiFlow data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of AutomationV4ApiFlow fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of AutomationV4ApiFlow fields).
     */
    ...
    /**
     * Load a single AutomationV4ApiFlow.
     *
     * @param AutomationV4ApiFlowLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed AutomationV4ApiFlowLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return AutomationV4ApiFlow|array The loaded AutomationV4ApiFlow as an assoc-array at the
    ...
    /**
     * Create a new AutomationV4ApiFlow.
     *
     * @param AutomationV4ApiFlowCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed AutomationV4ApiFlowCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return AutomationV4ApiFlow|array The created AutomationV4ApiFlow as an assoc-array at the
     *   SDK boundary; throws HubspotAutomationError on failure (item-5 convention).
     */
    ...
    /**
     * Update an existing AutomationV4ApiFlow.
     *
     * @param AutomationV4ApiFlowUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed AutomationV4ApiFlowUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return AutomationV4ApiFlow|array The updated AutomationV4ApiFlow as an assoc-array at the
     *   SDK boundary; throws HubspotAutomationError on failure (item-5 convention).
     */
