...
class AutomationV4CollectionResponseApiFlowListingForwardPagingEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "automation_v4_collection_response_api_flow_listing_forward_paging";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new AutomationV4CollectionResponseApiFlowListingForwardPagingEntity($this->_client, $opts);
    }

    /**
     * @param AutomationV4CollectionResponseApiFlowListingForwardPaging|array $args AutomationV4CollectionResponseApiFlowListingForwardPaging data (assoc-array) to store.
     */
    ...
    /**
     * @return AutomationV4CollectionResponseApiFlowListingForwardPaging|array The current AutomationV4CollectionResponseApiFlowListingForwardPaging data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of AutomationV4CollectionResponseApiFlowListingForwardPaging fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of AutomationV4CollectionResponseApiFlowListingForwardPaging fields).
     */
    ...
    /**
     * List AutomationV4CollectionResponseApiFlowListingForwardPaging items matching the given filter.
     *
     * @param AutomationV4CollectionResponseApiFlowListingForwardPagingListMatch|array|null $reqmatch Match filter (any subset
     *   of AutomationV4CollectionResponseApiFlowListingForwardPaging fields) as an assoc-array; AutomationV4CollectionResponseApiFlowListingForwardPagingListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return AutomationV4CollectionResponseApiFlowListingForwardPaging[]|array A list of AutomationV4CollectionResponseApiFlowListingForwardPaging items as assoc-arrays at
