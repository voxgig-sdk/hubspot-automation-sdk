...
class AutomationV4BatchResponseFlowIdWorkflowIdMappingEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "automation_v4_batch_response_flow_id_workflow_id_mapping";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new AutomationV4BatchResponseFlowIdWorkflowIdMappingEntity($this->_client, $opts);
    }

    /**
     * @param AutomationV4BatchResponseFlowIdWorkflowIdMapping|array $args AutomationV4BatchResponseFlowIdWorkflowIdMapping data (assoc-array) to store.
     */
    ...
    /**
     * @return AutomationV4BatchResponseFlowIdWorkflowIdMapping|array The current AutomationV4BatchResponseFlowIdWorkflowIdMapping data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of AutomationV4BatchResponseFlowIdWorkflowIdMapping fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of AutomationV4BatchResponseFlowIdWorkflowIdMapping fields).
     */
    ...
    /**
     * Create a new AutomationV4BatchResponseFlowIdWorkflowIdMapping.
     *
     * @param AutomationV4BatchResponseFlowIdWorkflowIdMappingCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed AutomationV4BatchResponseFlowIdWorkflowIdMappingCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return AutomationV4BatchResponseFlowIdWorkflowIdMapping|array The created AutomationV4BatchResponseFlowIdWorkflowIdMapping as an assoc-array at the
