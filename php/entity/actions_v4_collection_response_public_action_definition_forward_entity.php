...
class ActionsV4CollectionResponsePublicActionDefinitionForwardEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "actions_v4_collection_response_public_action_definition_forward";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ActionsV4CollectionResponsePublicActionDefinitionForwardEntity($this->_client, $opts);
    }

    /**
     * @param ActionsV4CollectionResponsePublicActionDefinitionForward|array $args ActionsV4CollectionResponsePublicActionDefinitionForward data (assoc-array) to store.
     */
    ...
    /**
     * @return ActionsV4CollectionResponsePublicActionDefinitionForward|array The current ActionsV4CollectionResponsePublicActionDefinitionForward data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ActionsV4CollectionResponsePublicActionDefinitionForward fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ActionsV4CollectionResponsePublicActionDefinitionForward fields).
     */
    ...
    /**
     * Load a single ActionsV4CollectionResponsePublicActionDefinitionForward.
     *
     * @param ActionsV4CollectionResponsePublicActionDefinitionForwardLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ActionsV4CollectionResponsePublicActionDefinitionForwardLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ActionsV4CollectionResponsePublicActionDefinitionForward|array The loaded ActionsV4CollectionResponsePublicActionDefinitionForward as an assoc-array at the
