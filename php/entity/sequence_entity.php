...
// HubspotAutomation SDK Sequence entity
...
class SequenceEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new SequenceEntity($this->_client, $opts);
    }

    /**
     * @param Sequence|array $args Sequence data (assoc-array) to store.
     */
    ...
    /**
     * @return Sequence|array The current Sequence data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Sequence fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Sequence fields).
     */
     ...
     *
     * @param SequenceLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed SequenceLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Sequence|array The loaded Sequence as an assoc-array at the
    ...
    /**
     * List Sequence items matching the given filter.
     *
     * @param SequenceListMatch|array|null $reqmatch Match filter (any subset
     *   of Sequence fields) as an assoc-array; SequenceListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Sequence[]|array A list of Sequence items as assoc-arrays at
     ...
     *
     * @param SequenceCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed SequenceCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Sequence|array The created Sequence as an assoc-array at the
     *   SDK boundary; throws HubspotAutomationError on failure (item-5 convention).
     */
     ...
     *
     * @param SequenceUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed SequenceUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Sequence|array The updated Sequence as an assoc-array at the
     *   SDK boundary; throws HubspotAutomationError on failure (item-5 convention).
     */
