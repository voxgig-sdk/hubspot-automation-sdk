...
class SequencesCollectionResponseWithTotalPublicSequenceLiteEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "sequences_collection_response_with_total_public_sequence_lite";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new SequencesCollectionResponseWithTotalPublicSequenceLiteEntity($this->_client, $opts);
    }

    /**
     * @param SequencesCollectionResponseWithTotalPublicSequenceLite|array $args SequencesCollectionResponseWithTotalPublicSequenceLite data (assoc-array) to store.
     */
    ...
    /**
     * @return SequencesCollectionResponseWithTotalPublicSequenceLite|array The current SequencesCollectionResponseWithTotalPublicSequenceLite data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of SequencesCollectionResponseWithTotalPublicSequenceLite fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of SequencesCollectionResponseWithTotalPublicSequenceLite fields).
     */
    ...
    /**
     * List SequencesCollectionResponseWithTotalPublicSequenceLite items matching the given filter.
     *
     * @param SequencesCollectionResponseWithTotalPublicSequenceLiteListMatch|array|null $reqmatch Match filter (any subset
     *   of SequencesCollectionResponseWithTotalPublicSequenceLite fields) as an assoc-array; SequencesCollectionResponseWithTotalPublicSequenceLiteListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return SequencesCollectionResponseWithTotalPublicSequenceLite[]|array A list of SequencesCollectionResponseWithTotalPublicSequenceLite items as assoc-arrays at
