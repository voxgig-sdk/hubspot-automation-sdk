...
// HubspotAutomation SDK SequencesPublicSequence entity
...
class SequencesPublicSequenceEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "sequences_public_sequence";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new SequencesPublicSequenceEntity($this->_client, $opts);
    }

    /**
     * @param SequencesPublicSequence|array $args SequencesPublicSequence data (assoc-array) to store.
     */
    ...
    /**
     * @return SequencesPublicSequence|array The current SequencesPublicSequence data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of SequencesPublicSequence fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of SequencesPublicSequence fields).
     */
    ...
    /**
     * Load a single SequencesPublicSequence.
     *
     * @param SequencesPublicSequenceLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed SequencesPublicSequenceLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return SequencesPublicSequence|array The loaded SequencesPublicSequence as an assoc-array at the
