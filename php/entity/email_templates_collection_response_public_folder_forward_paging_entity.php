...
class EmailTemplatesCollectionResponsePublicFolderForwardPagingEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "email_templates_collection_response_public_folder_forward_paging";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new EmailTemplatesCollectionResponsePublicFolderForwardPagingEntity($this->_client, $opts);
    }

    /**
     * @param EmailTemplatesCollectionResponsePublicFolderForwardPaging|array $args EmailTemplatesCollectionResponsePublicFolderForwardPaging data (assoc-array) to store.
     */
    ...
    /**
     * @return EmailTemplatesCollectionResponsePublicFolderForwardPaging|array The current EmailTemplatesCollectionResponsePublicFolderForwardPaging data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of EmailTemplatesCollectionResponsePublicFolderForwardPaging fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of EmailTemplatesCollectionResponsePublicFolderForwardPaging fields).
     */
    ...
    /**
     * List EmailTemplatesCollectionResponsePublicFolderForwardPaging items matching the given filter.
     *
     * @param EmailTemplatesCollectionResponsePublicFolderForwardPagingListMatch|array|null $reqmatch Match filter (any subset
     *   of EmailTemplatesCollectionResponsePublicFolderForwardPaging fields) as an assoc-array; EmailTemplatesCollectionResponsePublicFolderForwardPagingListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return EmailTemplatesCollectionResponsePublicFolderForwardPaging[]|array A list of EmailTemplatesCollectionResponsePublicFolderForwardPaging items as assoc-arrays at
