...
// HubspotAutomation SDK Basic entity
...
class BasicEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new BasicEntity($this->_client, $opts);
    }

    /**
     * @param Basic|array $args Basic data (assoc-array) to store.
     */
    ...
    /**
     * @return Basic|array The current Basic data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Basic fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Basic fields).
     */
    ...
    /**
     * Remove an Basic matching the given criteria.
     *
     * @param BasicRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; BasicRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Basic|array The removed Basic as an assoc-array at the
