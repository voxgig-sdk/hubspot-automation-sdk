...
class ActionsV4CollectionResponsePublicActionRevisionForwardEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ActionsV4CollectionResponsePublicActionRevisionForwardEntity(self._client, opts)
    ...
    def data_get(self) -> ActionsV4CollectionResponsePublicActionRevisionForward:
    ...
    def match_get(self) -> ActionsV4CollectionResponsePublicActionRevisionForward:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[ActionsV4CollectionResponsePublicActionRevisionForward]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.ActionsV4CollectionResponsePublicActionRevisionForward().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
