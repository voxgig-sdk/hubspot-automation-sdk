...
class SequencesPublicSequenceEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return SequencesPublicSequenceEntity(self._client, opts)
    ...
    def data_get(self) -> SequencesPublicSequence:
    ...
    def match_get(self) -> SequencesPublicSequence:
    ...
    def load(self, reqmatch=None, ctrl=None) -> SequencesPublicSequence:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.SequencesPublicSequence().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
