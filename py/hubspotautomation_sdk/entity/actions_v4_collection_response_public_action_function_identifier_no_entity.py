...
class ActionsV4CollectionResponsePublicActionFunctionIdentifierNoEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ActionsV4CollectionResponsePublicActionFunctionIdentifierNoEntity(self._client, opts)
    ...
    def data_get(self) -> ActionsV4CollectionResponsePublicActionFunctionIdentifierNo:
    ...
    def match_get(self) -> ActionsV4CollectionResponsePublicActionFunctionIdentifierNo:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[ActionsV4CollectionResponsePublicActionFunctionIdentifierNo]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.ActionsV4CollectionResponsePublicActionFunctionIdentifierNo().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
