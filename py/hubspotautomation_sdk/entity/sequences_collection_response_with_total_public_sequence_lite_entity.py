...
class SequencesCollectionResponseWithTotalPublicSequenceLiteEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return SequencesCollectionResponseWithTotalPublicSequenceLiteEntity(self._client, opts)
    ...
    def data_get(self) -> SequencesCollectionResponseWithTotalPublicSequenceLite:
    ...
    def match_get(self) -> SequencesCollectionResponseWithTotalPublicSequenceLite:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[SequencesCollectionResponseWithTotalPublicSequenceLite]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.SequencesCollectionResponseWithTotalPublicSequenceLite().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
