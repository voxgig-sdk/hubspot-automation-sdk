...
class ActionsV4PublicActionFunctionEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ActionsV4PublicActionFunctionEntity(self._client, opts)
    ...
    def data_get(self) -> ActionsV4PublicActionFunction:
    ...
    def match_get(self) -> ActionsV4PublicActionFunction:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ActionsV4PublicActionFunction:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ActionsV4PublicActionFunction().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
