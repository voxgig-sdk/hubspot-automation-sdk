...
class AutomationV4CollectionResponseApiFlowEmailCampaignEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return AutomationV4CollectionResponseApiFlowEmailCampaignEntity(self._client, opts)
    ...
    def data_get(self) -> AutomationV4CollectionResponseApiFlowEmailCampaign:
    ...
    def match_get(self) -> AutomationV4CollectionResponseApiFlowEmailCampaign:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[AutomationV4CollectionResponseApiFlowEmailCampaign]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.AutomationV4CollectionResponseApiFlowEmailCampaign().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
