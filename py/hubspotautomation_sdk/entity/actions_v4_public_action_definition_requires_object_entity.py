...
class ActionsV4PublicActionDefinitionRequiresObjectEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ActionsV4PublicActionDefinitionRequiresObjectEntity(self._client, opts)
    ...
    def data_get(self) -> ActionsV4PublicActionDefinitionRequiresObject:
    ...
    def match_get(self) -> ActionsV4PublicActionDefinitionRequiresObject:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ActionsV4PublicActionDefinitionRequiresObject:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ActionsV4PublicActionDefinitionRequiresObject().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
