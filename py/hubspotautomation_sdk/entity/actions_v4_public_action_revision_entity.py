...
class ActionsV4PublicActionRevisionEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ActionsV4PublicActionRevisionEntity(self._client, opts)
    ...
    def data_get(self) -> ActionsV4PublicActionRevision:
    ...
    def match_get(self) -> ActionsV4PublicActionRevision:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ActionsV4PublicActionRevision:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ActionsV4PublicActionRevision().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
