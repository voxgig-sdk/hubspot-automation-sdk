...
class EmailTemplatesCollectionResponsePublicTemplateForwardPagingEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return EmailTemplatesCollectionResponsePublicTemplateForwardPagingEntity(self._client, opts)
    ...
    def data_get(self) -> EmailTemplatesCollectionResponsePublicTemplateForwardPaging:
    ...
    def match_get(self) -> EmailTemplatesCollectionResponsePublicTemplateForwardPaging:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[EmailTemplatesCollectionResponsePublicTemplateForwardPaging]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.EmailTemplatesCollectionResponsePublicTemplateForwardPaging().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
