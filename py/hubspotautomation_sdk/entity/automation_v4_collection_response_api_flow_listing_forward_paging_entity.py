...
class AutomationV4CollectionResponseApiFlowListingForwardPagingEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return AutomationV4CollectionResponseApiFlowListingForwardPagingEntity(self._client, opts)
    ...
    def data_get(self) -> AutomationV4CollectionResponseApiFlowListingForwardPaging:
    ...
    def match_get(self) -> AutomationV4CollectionResponseApiFlowListingForwardPaging:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[AutomationV4CollectionResponseApiFlowListingForwardPaging]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.AutomationV4CollectionResponseApiFlowListingForwardPaging().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
