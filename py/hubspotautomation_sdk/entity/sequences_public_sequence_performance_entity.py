...
class SequencesPublicSequencePerformanceEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return SequencesPublicSequencePerformanceEntity(self._client, opts)
    ...
    def data_get(self) -> SequencesPublicSequencePerformance:
    ...
    def match_get(self) -> SequencesPublicSequencePerformance:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[SequencesPublicSequencePerformance]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.SequencesPublicSequencePerformance().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
