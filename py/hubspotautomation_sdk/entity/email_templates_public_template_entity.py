...
class EmailTemplatesPublicTemplateEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return EmailTemplatesPublicTemplateEntity(self._client, opts)
    ...
    def data_get(self) -> EmailTemplatesPublicTemplate:
    ...
    def match_get(self) -> EmailTemplatesPublicTemplate:
    ...
    def load(self, reqmatch=None, ctrl=None) -> EmailTemplatesPublicTemplate:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.EmailTemplatesPublicTemplate().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def create(self, reqdata: EmailTemplatesPublicTemplateCreateData, ctrl=None) -> EmailTemplatesPublicTemplate:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "create",
            "ctrl": ctrl,
    ...
    def update(self, reqdata: EmailTemplatesPublicTemplateUpdateData, ctrl=None) -> EmailTemplatesPublicTemplate:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "update",
            "ctrl": ctrl,
