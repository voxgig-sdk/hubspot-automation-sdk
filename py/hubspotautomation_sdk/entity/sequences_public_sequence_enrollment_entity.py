...
class SequencesPublicSequenceEnrollmentEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return SequencesPublicSequenceEnrollmentEntity(self._client, opts)
    ...
    def data_get(self) -> SequencesPublicSequenceEnrollment:
    ...
    def match_get(self) -> SequencesPublicSequenceEnrollment:
    ...
    def load(self, reqmatch=None, ctrl=None) -> SequencesPublicSequenceEnrollment:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.SequencesPublicSequenceEnrollment().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
