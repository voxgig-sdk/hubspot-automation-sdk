...
class AutomationV4CollectionResponseApiHistogramDataPointNoEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return AutomationV4CollectionResponseApiHistogramDataPointNoEntity(self._client, opts)
    ...
    def data_get(self) -> AutomationV4CollectionResponseApiHistogramDataPointNo:
    ...
    def match_get(self) -> AutomationV4CollectionResponseApiHistogramDataPointNo:
    ...
    def load(self, reqmatch=None, ctrl=None) -> AutomationV4CollectionResponseApiHistogramDataPointNo:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.AutomationV4CollectionResponseApiHistogramDataPointNo().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
