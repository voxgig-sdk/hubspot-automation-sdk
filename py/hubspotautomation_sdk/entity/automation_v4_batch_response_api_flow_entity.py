...
class AutomationV4BatchResponseApiFlowEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return AutomationV4BatchResponseApiFlowEntity(self._client, opts)
    ...
    def data_get(self) -> AutomationV4BatchResponseApiFlow:
    ...
    def match_get(self) -> AutomationV4BatchResponseApiFlow:
    ...
    def create(self, reqdata: AutomationV4BatchResponseApiFlowCreateData, ctrl=None) -> AutomationV4BatchResponseApiFlow:
        utility = self._utility
