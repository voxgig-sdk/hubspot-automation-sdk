...
class SequencesPublicSequenceEnrollmentLiteEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return SequencesPublicSequenceEnrollmentLiteEntity(self._client, opts)
    ...
    def data_get(self) -> SequencesPublicSequenceEnrollmentLite:
    ...
    def match_get(self) -> SequencesPublicSequenceEnrollmentLite:
    ...
    def create(self, reqdata: SequencesPublicSequenceEnrollmentLiteCreateData, ctrl=None) -> SequencesPublicSequenceEnrollmentLite:
        utility = self._utility
