...
class AutomationV4BatchResponseFlowIdWorkflowIdMappingEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return AutomationV4BatchResponseFlowIdWorkflowIdMappingEntity(self._client, opts)
    ...
    def data_get(self) -> AutomationV4BatchResponseFlowIdWorkflowIdMapping:
    ...
    def match_get(self) -> AutomationV4BatchResponseFlowIdWorkflowIdMapping:
    ...
    def create(self, reqdata: AutomationV4BatchResponseFlowIdWorkflowIdMappingCreateData, ctrl=None) -> AutomationV4BatchResponseFlowIdWorkflowIdMapping:
        utility = self._utility
