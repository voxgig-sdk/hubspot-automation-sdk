...
class ActionsV4PublicActionFunctionIdentifierEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ActionsV4PublicActionFunctionIdentifierEntity(self._client, opts)
    ...
    def data_get(self) -> ActionsV4PublicActionFunctionIdentifier:
    ...
    def match_get(self) -> ActionsV4PublicActionFunctionIdentifier:
    ...
    def update(self, reqdata: ActionsV4PublicActionFunctionIdentifierUpdateData, ctrl=None) -> ActionsV4PublicActionFunctionIdentifier:
        utility = self._utility
