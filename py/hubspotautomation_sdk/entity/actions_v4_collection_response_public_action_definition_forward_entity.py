...
class ActionsV4CollectionResponsePublicActionDefinitionForwardEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ActionsV4CollectionResponsePublicActionDefinitionForwardEntity(self._client, opts)
    ...
    def data_get(self) -> ActionsV4CollectionResponsePublicActionDefinitionForward:
    ...
    def match_get(self) -> ActionsV4CollectionResponsePublicActionDefinitionForward:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ActionsV4CollectionResponsePublicActionDefinitionForward:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ActionsV4CollectionResponsePublicActionDefinitionForward().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
