...
class EmailTemplatesCollectionResponsePublicFolderForwardPagingEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return EmailTemplatesCollectionResponsePublicFolderForwardPagingEntity(self._client, opts)
    ...
    def data_get(self) -> EmailTemplatesCollectionResponsePublicFolderForwardPaging:
    ...
    def match_get(self) -> EmailTemplatesCollectionResponsePublicFolderForwardPaging:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[EmailTemplatesCollectionResponsePublicFolderForwardPaging]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.EmailTemplatesCollectionResponsePublicFolderForwardPaging().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
