...
from hubspotautomation_sdk.hubspotautomation_types import (
...
class ActionsV4PublicActionDefinitionEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ActionsV4PublicActionDefinitionEntity(self._client, opts)
    ...
    def data_get(self) -> ActionsV4PublicActionDefinition:
    ...
    def match_get(self) -> ActionsV4PublicActionDefinition:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ActionsV4PublicActionDefinition:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ActionsV4PublicActionDefinition().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def create(self, reqdata: ActionsV4PublicActionDefinitionCreateData, ctrl=None) -> ActionsV4PublicActionDefinition:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "create",
            "ctrl": ctrl,
    ...
    def update(self, reqdata: ActionsV4PublicActionDefinitionUpdateData, ctrl=None) -> ActionsV4PublicActionDefinition:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "update",
            "ctrl": ctrl,
