...
from hubspotautomation_sdk.core.control import HubspotAutomationControl
...
from hubspotautomation_sdk.core.helpers import get_ctx_prop, to_map
...
class HubspotAutomationContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = HubspotAutomationControl()
        ...
        if isinstance(sp, HubspotAutomationSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, HubspotAutomationResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, HubspotAutomationResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return HubspotAutomationOperation({})
    ...
    def make_error(self, code, msg):
        return HubspotAutomationError(code, msg, self)
