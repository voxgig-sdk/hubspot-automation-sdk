# HubspotAutomation SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions HubspotAutomationSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both HubspotAutomationSDK(...) and HubspotAutomationSDK.test(...) become
#      HubspotAutomationSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "hubspotautomation_sdk"
_SDK_CLASS = "HubspotAutomationSDK"
...
_ENTITIES = {
    "ActionsV4CollectionResponsePublicActionDefinitionForward": "actions_v4_collection_response_public_action_definition_forward",
    "ActionsV4CollectionResponsePublicActionFunctionIdentifierNo": "actions_v4_collection_response_public_action_function_identifier_no",
    "ActionsV4CollectionResponsePublicActionRevisionForward": "actions_v4_collection_response_public_action_revision_forward",
    "ActionsV4PublicActionDefinition": "actions_v4_public_action_definition",
    "ActionsV4PublicActionDefinitionRequiresObject": "actions_v4_public_action_definition_requires_object",
    "ActionsV4PublicActionFunction": "actions_v4_public_action_function",
    "ActionsV4PublicActionFunctionIdentifier": "actions_v4_public_action_function_identifier",
    "ActionsV4PublicActionRevision": "actions_v4_public_action_revision",
    "AutomationV4ApiFlow": "automation_v4_api_flow",
    "AutomationV4BatchResponseApiFlow": "automation_v4_batch_response_api_flow",
    "AutomationV4BatchResponseFlowIdWorkflowIdMapping": "automation_v4_batch_response_flow_id_workflow_id_mapping",
    "AutomationV4CollectionResponseApiFlowEmailCampaign": "automation_v4_collection_response_api_flow_email_campaign",
    "AutomationV4CollectionResponseApiFlowListingForwardPaging": "automation_v4_collection_response_api_flow_listing_forward_paging",
    "AutomationV4CollectionResponseApiHistogramDataPointNo": "automation_v4_collection_response_api_histogram_data_point_no",
    "Basic": "basic",
    "Callback": "callback",
    "Definition": "definition",
    "EmailTemplatesCollectionResponsePublicFolderForwardPaging": "email_templates_collection_response_public_folder_forward_paging",
    "EmailTemplatesCollectionResponsePublicTemplateForwardPaging": "email_templates_collection_response_public_template_forward_paging",
    "EmailTemplatesPublicTemplate": "email_templates_public_template",
    "Function": "function",
    "Sequence": "sequence",
    "SequencesCollectionResponseWithTotalPublicSequenceLite": "sequences_collection_response_with_total_public_sequence_lite",
    "SequencesPublicSequence": "sequences_public_sequence",
    "SequencesPublicSequenceEnrollment": "sequences_public_sequence_enrollment",
    "SequencesPublicSequenceEnrollmentLite": "sequences_public_sequence_enrollment_lite",
    "SequencesPublicSequencePerformance": "sequences_public_sequence_performance",
}
