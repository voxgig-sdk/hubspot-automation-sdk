...
class TestActionsV4CollectionResponsePublicActionFunctionIdentifierNoDirect:

    def test_should_direct_list_actions_v4_collection_response_public_action_function_identifier_no(self):
        setup = _actions_v4_collection_response_public_action_function_identifier_no_direct_setup([
            {"id": "direct01"},
            {"id": "direct02"},
        ])
        _skip, _reason = runner.is_control_skipped("direct", "direct-list-actions_v4_collection_response_public_action_function_identifier_no", "live" if setup["live"] else "unit")
        if _skip:
...
def _actions_v4_collection_response_public_action_function_identifier_no_direct_setup(mockres):
