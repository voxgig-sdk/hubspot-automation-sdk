...
class TestAutomationV4ApiFlowDirect:

    def test_should_direct_load_automation_v4_api_flow(self):
        setup = _automation_v4_api_flow_direct_setup({"id": "direct01"})
        _skip, _reason = runner.is_control_skipped("direct", "direct-load-automation_v4_api_flow", "live" if setup["live"] else "unit")
        if _skip:
...
def _automation_v4_api_flow_direct_setup(mockres):
