...
describe('EmailTemplatesPublicTemplateEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    // UPDATE
    const email_templates_public_template_ref01_data_up0 = {}
    ...
    email_templates_public_template_ref01_data_up0 [email_templates_public_template_ref01_markdef_up0.name] = email_templates_public_template_ref01_markdef_up0.value
    ...
    assert(email_templates_public_template_ref01_resdata_up0[email_templates_public_template_ref01_markdef_up0.name] === email_templates_public_template_ref01_markdef_up0.value)


    // LOAD
    const email_templates_public_template_ref01_match_dt0 = {}
