...
describe('ActionsV4PublicActionFunctionIdentifierEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    assert(actions_v4_public_action_function_identifier_ref01_resdata_up0[actions_v4_public_action_function_identifier_ref01_markdef_up0.name] === actions_v4_public_action_function_identifier_ref01_markdef_up0.value)
