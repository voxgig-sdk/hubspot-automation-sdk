...
func NewFunctionEntity(client *core.HubspotAutomationSDK, entopts map[string]any) *FunctionEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *FunctionEntity) GetName() string { return e.name }
...
func (e *FunctionEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *FunctionEntity) Deleted() bool {
	return e.deleted
}


func (e *FunctionEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewFunctionEntity(e.client, opts)
}

func (e *FunctionEntity) Data(args ...any) any {
...
func (e *FunctionEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Function; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *FunctionEntity) DataTyped(data ...Function) Function {
	if len(data) > 0 {
		return typedFrom[Function](e.Data(asMap(data[0])))
	}
	return typedFrom[Function](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Function (all fields
// optional at the wire level).
func (e *FunctionEntity) MatchTyped(match ...Function) Function {
	if len(match) > 0 {
		return typedFrom[Function](e.Match(asMap(match[0])))
	}
	return typedFrom[Function](e.Match())
}
...
func (e *FunctionEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *FunctionEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *FunctionEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *FunctionEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *FunctionEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}



func (e *FunctionEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// FunctionRemoveMatch and returns an Function. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *FunctionEntity) RemoveTyped(reqmatch FunctionRemoveMatch, ctrl map[string]any) (Function, error) {
	res, err := e.Remove(asMap(reqmatch), ctrl)
	if err != nil {
		return Function{}, err
	}
	return typedFrom[Function](res), nil
}



func (e *FunctionEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
