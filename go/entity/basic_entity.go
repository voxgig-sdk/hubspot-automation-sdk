...
func NewBasicEntity(client *core.HubspotAutomationSDK, entopts map[string]any) *BasicEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *BasicEntity) GetName() string { return e.name }
...
func (e *BasicEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *BasicEntity) Deleted() bool {
	return e.deleted
}


func (e *BasicEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewBasicEntity(e.client, opts)
}

func (e *BasicEntity) Data(args ...any) any {
...
func (e *BasicEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Basic; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *BasicEntity) DataTyped(data ...Basic) Basic {
	if len(data) > 0 {
		return typedFrom[Basic](e.Data(asMap(data[0])))
	}
	return typedFrom[Basic](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Basic (all fields
// optional at the wire level).
func (e *BasicEntity) MatchTyped(match ...Basic) Basic {
	if len(match) > 0 {
		return typedFrom[Basic](e.Match(asMap(match[0])))
	}
	return typedFrom[Basic](e.Match())
}
...
func (e *BasicEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *BasicEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *BasicEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *BasicEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *BasicEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}



func (e *BasicEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// BasicRemoveMatch and returns an Basic. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *BasicEntity) RemoveTyped(reqmatch BasicRemoveMatch, ctrl map[string]any) (Basic, error) {
	res, err := e.Remove(asMap(reqmatch), ctrl)
	if err != nil {
		return Basic{}, err
	}
	return typedFrom[Basic](res), nil
}



func (e *BasicEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
