...
func NewDefinitionEntity(client *core.HubspotAutomationSDK, entopts map[string]any) *DefinitionEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DefinitionEntity) GetName() string { return e.name }
...
func (e *DefinitionEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *DefinitionEntity) Deleted() bool {
	return e.deleted
}


func (e *DefinitionEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewDefinitionEntity(e.client, opts)
}

func (e *DefinitionEntity) Data(args ...any) any {
...
func (e *DefinitionEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Definition; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *DefinitionEntity) DataTyped(data ...Definition) Definition {
	if len(data) > 0 {
		return typedFrom[Definition](e.Data(asMap(data[0])))
	}
	return typedFrom[Definition](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Definition (all fields
// optional at the wire level).
func (e *DefinitionEntity) MatchTyped(match ...Definition) Definition {
	if len(match) > 0 {
		return typedFrom[Definition](e.Match(asMap(match[0])))
	}
	return typedFrom[Definition](e.Match())
}
...
func (e *DefinitionEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *DefinitionEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *DefinitionEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *DefinitionEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// DefinitionCreateData and returns an Definition. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *DefinitionEntity) CreateTyped(reqdata DefinitionCreateData, ctrl map[string]any) (Definition, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return Definition{}, err
	}
	return typedFrom[Definition](res), nil
}



func (e *DefinitionEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}



func (e *DefinitionEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
// DefinitionRemoveMatch and returns an Definition. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *DefinitionEntity) RemoveTyped(reqmatch DefinitionRemoveMatch, ctrl map[string]any) (Definition, error) {
...
func (e *DefinitionEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
