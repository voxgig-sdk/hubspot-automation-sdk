...
func NewCallbackEntity(client *core.HubspotAutomationSDK, entopts map[string]any) *CallbackEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CallbackEntity) GetName() string { return e.name }
...
func (e *CallbackEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CallbackEntity) Deleted() bool {
	return e.deleted
}


func (e *CallbackEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCallbackEntity(e.client, opts)
}

func (e *CallbackEntity) Data(args ...any) any {
...
func (e *CallbackEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Callback; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CallbackEntity) DataTyped(data ...Callback) Callback {
	if len(data) > 0 {
		return typedFrom[Callback](e.Data(asMap(data[0])))
	}
	return typedFrom[Callback](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Callback (all fields
// optional at the wire level).
func (e *CallbackEntity) MatchTyped(match ...Callback) Callback {
	if len(match) > 0 {
		return typedFrom[Callback](e.Match(asMap(match[0])))
	}
	return typedFrom[Callback](e.Match())
}
...
func (e *CallbackEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CallbackEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *CallbackEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *CallbackEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CallbackCreateData and returns an Callback. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *CallbackEntity) CreateTyped(reqdata CallbackCreateData, ctrl map[string]any) (Callback, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return Callback{}, err
	}
	return typedFrom[Callback](res), nil
}



func (e *CallbackEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CallbackEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CallbackEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
