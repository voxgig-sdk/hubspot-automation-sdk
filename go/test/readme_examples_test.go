...
const testSeed = `map[string]any{"entity": map[string]any{"actions_v4_collection_response_public_action_definition_forward": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "actions_v4_collection_response_public_action_function_identifier_no": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "actions_v4_collection_response_public_action_revision_forward": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "actions_v4_public_action_definition": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "actions_v4_public_action_definition_requires_object": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "actions_v4_public_action_function": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "actions_v4_public_action_function_identifier": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "actions_v4_public_action_revision": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "automation_v4_api_flow": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "automation_v4_batch_response_api_flow": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "automation_v4_batch_response_flow_id_workflow_id_mapping": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "automation_v4_collection_response_api_flow_email_campaign": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "automation_v4_collection_response_api_flow_listing_forward_paging": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "automation_v4_collection_response_api_histogram_data_point_no": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "basic": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "callback": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "definition": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "email_templates_collection_response_public_folder_forward_paging": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "email_templates_collection_response_public_template_forward_paging": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "email_templates_public_template": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "function": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "sequence": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "sequences_collection_response_with_total_public_sequence_lite": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "sequences_public_sequence": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "sequences_public_sequence_enrollment": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "sequences_public_sequence_enrollment_lite": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "sequences_public_sequence_performance": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
