...
describe("AutomationV4CollectionResponseApiHistogramDataPointNoDirect", function()
  it("should direct-load-automation_v4_collection_response_api_histogram_data_point_no", function()
    local setup = automation_v4_collection_response_api_histogram_data_point_no_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-automation_v4_collection_response_api_histogram_data_point_no", setup.live and "live" or "unit")
