...
describe("AutomationV4CollectionResponseApiFlowEmailCampaignDirect", function()
  it("should direct-list-automation_v4_collection_response_api_flow_email_campaign", function()
    local setup = automation_v4_collection_response_api_flow_email_campaign_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-automation_v4_collection_response_api_flow_email_campaign", setup.live and "live" or "unit")
