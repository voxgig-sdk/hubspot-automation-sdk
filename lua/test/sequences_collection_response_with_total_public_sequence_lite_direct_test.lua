...
describe("SequencesCollectionResponseWithTotalPublicSequenceLiteDirect", function()
  it("should direct-list-sequences_collection_response_with_total_public_sequence_lite", function()
    local setup = sequences_collection_response_with_total_public_sequence_lite_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-sequences_collection_response_with_total_public_sequence_lite", setup.live and "live" or "unit")
