...
describe("ActionsV4PublicActionFunctionDirect", function()
  it("should direct-load-actions_v4_public_action_function", function()
    local setup = actions_v4_public_action_function_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-actions_v4_public_action_function", setup.live and "live" or "unit")
