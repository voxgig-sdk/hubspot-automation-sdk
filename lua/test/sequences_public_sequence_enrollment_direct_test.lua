...
describe("SequencesPublicSequenceEnrollmentDirect", function()
  it("should direct-load-sequences_public_sequence_enrollment", function()
    local setup = sequences_public_sequence_enrollment_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-sequences_public_sequence_enrollment", setup.live and "live" or "unit")
