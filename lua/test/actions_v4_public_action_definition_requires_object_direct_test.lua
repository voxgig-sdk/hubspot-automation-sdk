...
describe("ActionsV4PublicActionDefinitionRequiresObjectDirect", function()
  it("should direct-load-actions_v4_public_action_definition_requires_object", function()
    local setup = actions_v4_public_action_definition_requires_object_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-actions_v4_public_action_definition_requires_object", setup.live and "live" or "unit")
