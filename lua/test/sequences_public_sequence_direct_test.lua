...
describe("SequencesPublicSequenceDirect", function()
  it("should direct-load-sequences_public_sequence", function()
    local setup = sequences_public_sequence_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-sequences_public_sequence", setup.live and "live" or "unit")
