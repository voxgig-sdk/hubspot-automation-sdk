...
describe("ActionsV4CollectionResponsePublicActionDefinitionForwardDirect", function()
  it("should direct-load-actions_v4_collection_response_public_action_definition_forward", function()
    local setup = actions_v4_collection_response_public_action_definition_forward_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-actions_v4_collection_response_public_action_definition_forward", setup.live and "live" or "unit")
