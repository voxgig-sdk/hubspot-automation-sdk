...
describe("EmailTemplatesPublicTemplateDirect", function()
  it("should direct-load-email_templates_public_template", function()
    local setup = email_templates_public_template_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-email_templates_public_template", setup.live and "live" or "unit")
