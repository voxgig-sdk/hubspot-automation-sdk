...
describe("EmailTemplatesCollectionResponsePublicTemplateForwardPagingDirect", function()
  it("should direct-list-email_templates_collection_response_public_template_forward_paging", function()
    local setup = email_templates_collection_response_public_template_forward_paging_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-email_templates_collection_response_public_template_forward_paging", setup.live and "live" or "unit")
