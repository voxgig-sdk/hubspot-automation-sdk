...
describe("BasicEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set HUBSPOT_AUTOMATION_TEST_BASIC_ENTID JSON to run live")
      return
    end
...
function basic_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("HUBSPOT_AUTOMATION_TEST_BASIC_ENTID")
