...
describe("ActionsV4PublicActionRevisionDirect", function()
  it("should direct-load-actions_v4_public_action_revision", function()
    local setup = actions_v4_public_action_revision_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-actions_v4_public_action_revision", setup.live and "live" or "unit")
