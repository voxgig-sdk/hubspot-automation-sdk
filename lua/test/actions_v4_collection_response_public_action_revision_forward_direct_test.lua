...
describe("ActionsV4CollectionResponsePublicActionRevisionForwardDirect", function()
  it("should direct-list-actions_v4_collection_response_public_action_revision_forward", function()
    local setup = actions_v4_collection_response_public_action_revision_forward_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-actions_v4_collection_response_public_action_revision_forward", setup.live and "live" or "unit")
