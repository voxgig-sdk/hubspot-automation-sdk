...
describe("AutomationV4ApiFlowDirect", function()
  it("should direct-load-automation_v4_api_flow", function()
    local setup = automation_v4_api_flow_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-automation_v4_api_flow", setup.live and "live" or "unit")
