...
local ActionsV4PublicActionRevisionEntity = {}
ActionsV4PublicActionRevisionEntity.__index = ActionsV4PublicActionRevisionEntity


function ActionsV4PublicActionRevisionEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ActionsV4PublicActionRevisionEntity)
  self._name = "actions_v4_public_action_revision"
  self._client = client
...
function ActionsV4PublicActionRevisionEntity:get_name()
  return self._name
end


function ActionsV4PublicActionRevisionEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ActionsV4PublicActionRevisionEntity.new(self._client, opts)
end
...
function ActionsV4PublicActionRevisionEntity:mark_deleted()
  self._deleted = true
end


function ActionsV4PublicActionRevisionEntity:deleted()
  return true == self._deleted
end


function ActionsV4PublicActionRevisionEntity:data_set(args)
  if args ~= nil then
...
function ActionsV4PublicActionRevisionEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ActionsV4PublicActionRevisionEntity:match_set(args)
  if args ~= nil then
...
function ActionsV4PublicActionRevisionEntity:match_get()
...
function ActionsV4PublicActionRevisionEntity:stream(action, args, callopts)
...
---@param reqmatch ActionsV4PublicActionRevisionLoadMatch
---@param ctrl? table
---@return ActionsV4PublicActionRevision
---@return string? err
function ActionsV4PublicActionRevisionEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function ActionsV4PublicActionRevisionEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ActionsV4PublicActionRevisionEntity
