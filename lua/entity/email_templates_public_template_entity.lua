...
local EmailTemplatesPublicTemplateEntity = {}
EmailTemplatesPublicTemplateEntity.__index = EmailTemplatesPublicTemplateEntity


function EmailTemplatesPublicTemplateEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, EmailTemplatesPublicTemplateEntity)
  self._name = "email_templates_public_template"
  self._client = client
...
function EmailTemplatesPublicTemplateEntity:get_name()
  return self._name
end


function EmailTemplatesPublicTemplateEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return EmailTemplatesPublicTemplateEntity.new(self._client, opts)
end
...
function EmailTemplatesPublicTemplateEntity:mark_deleted()
  self._deleted = true
end


function EmailTemplatesPublicTemplateEntity:deleted()
  return true == self._deleted
end


function EmailTemplatesPublicTemplateEntity:data_set(args)
  if args ~= nil then
...
function EmailTemplatesPublicTemplateEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function EmailTemplatesPublicTemplateEntity:match_set(args)
  if args ~= nil then
...
function EmailTemplatesPublicTemplateEntity:match_get()
...
function EmailTemplatesPublicTemplateEntity:stream(action, args, callopts)
...
---@param reqmatch EmailTemplatesPublicTemplateLoadMatch
---@param ctrl? table
---@return EmailTemplatesPublicTemplate
---@return string? err
function EmailTemplatesPublicTemplateEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata EmailTemplatesPublicTemplateCreateData
---@param ctrl? table
---@return EmailTemplatesPublicTemplate
---@return string? err
function EmailTemplatesPublicTemplateEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata EmailTemplatesPublicTemplateUpdateData
---@param ctrl? table
---@return EmailTemplatesPublicTemplate
---@return string? err
function EmailTemplatesPublicTemplateEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function EmailTemplatesPublicTemplateEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return EmailTemplatesPublicTemplateEntity
