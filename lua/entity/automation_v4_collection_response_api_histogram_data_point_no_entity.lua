-- HubspotAutomation SDK AutomationV4CollectionResponseApiHistogramDataPointNo entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local AutomationV4CollectionResponseApiHistogramDataPointNoEntity = {}
AutomationV4CollectionResponseApiHistogramDataPointNoEntity.__index = AutomationV4CollectionResponseApiHistogramDataPointNoEntity


function AutomationV4CollectionResponseApiHistogramDataPointNoEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, AutomationV4CollectionResponseApiHistogramDataPointNoEntity)
  self._name = "automation_v4_collection_response_api_histogram_data_point_no"
  self._client = client
...
function AutomationV4CollectionResponseApiHistogramDataPointNoEntity:get_name()
  return self._name
end


function AutomationV4CollectionResponseApiHistogramDataPointNoEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return AutomationV4CollectionResponseApiHistogramDataPointNoEntity.new(self._client, opts)
end
...
function AutomationV4CollectionResponseApiHistogramDataPointNoEntity:mark_deleted()
  self._deleted = true
end


function AutomationV4CollectionResponseApiHistogramDataPointNoEntity:deleted()
  return true == self._deleted
end


function AutomationV4CollectionResponseApiHistogramDataPointNoEntity:data_set(args)
  if args ~= nil then
...
function AutomationV4CollectionResponseApiHistogramDataPointNoEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function AutomationV4CollectionResponseApiHistogramDataPointNoEntity:match_set(args)
  if args ~= nil then
...
function AutomationV4CollectionResponseApiHistogramDataPointNoEntity:match_get()
...
function AutomationV4CollectionResponseApiHistogramDataPointNoEntity:stream(action, args, callopts)
...
---@param reqmatch AutomationV4CollectionResponseApiHistogramDataPointNoLoadMatch
---@param ctrl? table
---@return AutomationV4CollectionResponseApiHistogramDataPointNo
---@return string? err
function AutomationV4CollectionResponseApiHistogramDataPointNoEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function AutomationV4CollectionResponseApiHistogramDataPointNoEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return AutomationV4CollectionResponseApiHistogramDataPointNoEntity
