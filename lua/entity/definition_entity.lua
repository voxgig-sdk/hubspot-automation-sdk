...
local DefinitionEntity = {}
DefinitionEntity.__index = DefinitionEntity


function DefinitionEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, DefinitionEntity)
...
function DefinitionEntity:get_name()
  return self._name
end


function DefinitionEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return DefinitionEntity.new(self._client, opts)
end
...
function DefinitionEntity:mark_deleted()
  self._deleted = true
end


function DefinitionEntity:deleted()
  return true == self._deleted
end


function DefinitionEntity:data_set(args)
  if args ~= nil then
...
function DefinitionEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function DefinitionEntity:match_set(args)
  if args ~= nil then
...
function DefinitionEntity:match_get()
...
function DefinitionEntity:stream(action, args, callopts)
...
---@param reqdata DefinitionCreateData
---@param ctrl? table
---@return Definition
---@return string? err
function DefinitionEntity:create(reqdata, ctrl)
  local utility = self._utility
...
---@param reqmatch DefinitionRemoveMatch
---@param ctrl? table
---@return Definition
---@return string? err
function DefinitionEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
...
function DefinitionEntity:_run_op(ctx, post_done)
  local utility = self._utility
