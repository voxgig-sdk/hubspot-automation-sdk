-- HubspotAutomation SDK AutomationV4BatchResponseFlowIdWorkflowIdMapping entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local AutomationV4BatchResponseFlowIdWorkflowIdMappingEntity = {}
AutomationV4BatchResponseFlowIdWorkflowIdMappingEntity.__index = AutomationV4BatchResponseFlowIdWorkflowIdMappingEntity


function AutomationV4BatchResponseFlowIdWorkflowIdMappingEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, AutomationV4BatchResponseFlowIdWorkflowIdMappingEntity)
  self._name = "automation_v4_batch_response_flow_id_workflow_id_mapping"
  self._client = client
...
function AutomationV4BatchResponseFlowIdWorkflowIdMappingEntity:get_name()
  return self._name
end


function AutomationV4BatchResponseFlowIdWorkflowIdMappingEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return AutomationV4BatchResponseFlowIdWorkflowIdMappingEntity.new(self._client, opts)
end
...
function AutomationV4BatchResponseFlowIdWorkflowIdMappingEntity:mark_deleted()
  self._deleted = true
end


function AutomationV4BatchResponseFlowIdWorkflowIdMappingEntity:deleted()
  return true == self._deleted
end


function AutomationV4BatchResponseFlowIdWorkflowIdMappingEntity:data_set(args)
  if args ~= nil then
...
function AutomationV4BatchResponseFlowIdWorkflowIdMappingEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function AutomationV4BatchResponseFlowIdWorkflowIdMappingEntity:match_set(args)
  if args ~= nil then
...
function AutomationV4BatchResponseFlowIdWorkflowIdMappingEntity:match_get()
...
function AutomationV4BatchResponseFlowIdWorkflowIdMappingEntity:stream(action, args, callopts)
...
---@param reqdata AutomationV4BatchResponseFlowIdWorkflowIdMappingCreateData
---@param ctrl? table
---@return AutomationV4BatchResponseFlowIdWorkflowIdMapping
---@return string? err
function AutomationV4BatchResponseFlowIdWorkflowIdMappingEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function AutomationV4BatchResponseFlowIdWorkflowIdMappingEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return AutomationV4BatchResponseFlowIdWorkflowIdMappingEntity
