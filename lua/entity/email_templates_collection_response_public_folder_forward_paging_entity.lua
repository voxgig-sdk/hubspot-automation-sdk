-- HubspotAutomation SDK EmailTemplatesCollectionResponsePublicFolderForwardPaging entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local EmailTemplatesCollectionResponsePublicFolderForwardPagingEntity = {}
EmailTemplatesCollectionResponsePublicFolderForwardPagingEntity.__index = EmailTemplatesCollectionResponsePublicFolderForwardPagingEntity


function EmailTemplatesCollectionResponsePublicFolderForwardPagingEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, EmailTemplatesCollectionResponsePublicFolderForwardPagingEntity)
  self._name = "email_templates_collection_response_public_folder_forward_paging"
  self._client = client
...
function EmailTemplatesCollectionResponsePublicFolderForwardPagingEntity:get_name()
  return self._name
end


function EmailTemplatesCollectionResponsePublicFolderForwardPagingEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return EmailTemplatesCollectionResponsePublicFolderForwardPagingEntity.new(self._client, opts)
end
...
function EmailTemplatesCollectionResponsePublicFolderForwardPagingEntity:mark_deleted()
  self._deleted = true
end


function EmailTemplatesCollectionResponsePublicFolderForwardPagingEntity:deleted()
  return true == self._deleted
end


function EmailTemplatesCollectionResponsePublicFolderForwardPagingEntity:data_set(args)
  if args ~= nil then
...
function EmailTemplatesCollectionResponsePublicFolderForwardPagingEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function EmailTemplatesCollectionResponsePublicFolderForwardPagingEntity:match_set(args)
  if args ~= nil then
...
function EmailTemplatesCollectionResponsePublicFolderForwardPagingEntity:match_get()
...
function EmailTemplatesCollectionResponsePublicFolderForwardPagingEntity:stream(action, args, callopts)
...
---@param reqmatch EmailTemplatesCollectionResponsePublicFolderForwardPagingListMatch
---@param ctrl? table
---@return EmailTemplatesCollectionResponsePublicFolderForwardPaging[]
---@return string? err
function EmailTemplatesCollectionResponsePublicFolderForwardPagingEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function EmailTemplatesCollectionResponsePublicFolderForwardPagingEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return EmailTemplatesCollectionResponsePublicFolderForwardPagingEntity
