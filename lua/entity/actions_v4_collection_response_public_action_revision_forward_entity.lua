-- HubspotAutomation SDK ActionsV4CollectionResponsePublicActionRevisionForward entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ActionsV4CollectionResponsePublicActionRevisionForwardEntity = {}
ActionsV4CollectionResponsePublicActionRevisionForwardEntity.__index = ActionsV4CollectionResponsePublicActionRevisionForwardEntity


function ActionsV4CollectionResponsePublicActionRevisionForwardEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ActionsV4CollectionResponsePublicActionRevisionForwardEntity)
  self._name = "actions_v4_collection_response_public_action_revision_forward"
  self._client = client
...
function ActionsV4CollectionResponsePublicActionRevisionForwardEntity:get_name()
  return self._name
end


function ActionsV4CollectionResponsePublicActionRevisionForwardEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ActionsV4CollectionResponsePublicActionRevisionForwardEntity.new(self._client, opts)
end
...
function ActionsV4CollectionResponsePublicActionRevisionForwardEntity:mark_deleted()
  self._deleted = true
end


function ActionsV4CollectionResponsePublicActionRevisionForwardEntity:deleted()
  return true == self._deleted
end


function ActionsV4CollectionResponsePublicActionRevisionForwardEntity:data_set(args)
  if args ~= nil then
...
function ActionsV4CollectionResponsePublicActionRevisionForwardEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ActionsV4CollectionResponsePublicActionRevisionForwardEntity:match_set(args)
  if args ~= nil then
...
function ActionsV4CollectionResponsePublicActionRevisionForwardEntity:match_get()
...
function ActionsV4CollectionResponsePublicActionRevisionForwardEntity:stream(action, args, callopts)
...
---@param reqmatch ActionsV4CollectionResponsePublicActionRevisionForwardListMatch
---@param ctrl? table
---@return ActionsV4CollectionResponsePublicActionRevisionForward[]
---@return string? err
function ActionsV4CollectionResponsePublicActionRevisionForwardEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function ActionsV4CollectionResponsePublicActionRevisionForwardEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ActionsV4CollectionResponsePublicActionRevisionForwardEntity
