-- HubspotAutomation SDK AutomationV4CollectionResponseApiFlowEmailCampaign entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local AutomationV4CollectionResponseApiFlowEmailCampaignEntity = {}
AutomationV4CollectionResponseApiFlowEmailCampaignEntity.__index = AutomationV4CollectionResponseApiFlowEmailCampaignEntity


function AutomationV4CollectionResponseApiFlowEmailCampaignEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, AutomationV4CollectionResponseApiFlowEmailCampaignEntity)
  self._name = "automation_v4_collection_response_api_flow_email_campaign"
  self._client = client
...
function AutomationV4CollectionResponseApiFlowEmailCampaignEntity:get_name()
  return self._name
end


function AutomationV4CollectionResponseApiFlowEmailCampaignEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return AutomationV4CollectionResponseApiFlowEmailCampaignEntity.new(self._client, opts)
end
...
function AutomationV4CollectionResponseApiFlowEmailCampaignEntity:mark_deleted()
  self._deleted = true
end


function AutomationV4CollectionResponseApiFlowEmailCampaignEntity:deleted()
  return true == self._deleted
end


function AutomationV4CollectionResponseApiFlowEmailCampaignEntity:data_set(args)
  if args ~= nil then
...
function AutomationV4CollectionResponseApiFlowEmailCampaignEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function AutomationV4CollectionResponseApiFlowEmailCampaignEntity:match_set(args)
  if args ~= nil then
...
function AutomationV4CollectionResponseApiFlowEmailCampaignEntity:match_get()
...
function AutomationV4CollectionResponseApiFlowEmailCampaignEntity:stream(action, args, callopts)
...
---@param reqmatch AutomationV4CollectionResponseApiFlowEmailCampaignListMatch
---@param ctrl? table
---@return AutomationV4CollectionResponseApiFlowEmailCampaign[]
---@return string? err
function AutomationV4CollectionResponseApiFlowEmailCampaignEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function AutomationV4CollectionResponseApiFlowEmailCampaignEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return AutomationV4CollectionResponseApiFlowEmailCampaignEntity
