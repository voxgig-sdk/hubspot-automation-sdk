...
local SequenceEntity = {}
SequenceEntity.__index = SequenceEntity


function SequenceEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, SequenceEntity)
  self._name = "sequence"
  self._client = client
...
function SequenceEntity:get_name()
  return self._name
end


function SequenceEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return SequenceEntity.new(self._client, opts)
end
...
function SequenceEntity:mark_deleted()
  self._deleted = true
end


function SequenceEntity:deleted()
  return true == self._deleted
end


function SequenceEntity:data_set(args)
  if args ~= nil then
...
function SequenceEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function SequenceEntity:match_set(args)
  if args ~= nil then
...
function SequenceEntity:match_get()
...
function SequenceEntity:stream(action, args, callopts)
...
---@param reqmatch SequenceLoadMatch
---@param ctrl? table
---@return Sequence
---@return string? err
function SequenceEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch SequenceListMatch
---@param ctrl? table
---@return Sequence[]
---@return string? err
function SequenceEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata SequenceCreateData
---@param ctrl? table
---@return Sequence
---@return string? err
function SequenceEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata SequenceUpdateData
---@param ctrl? table
---@return Sequence
---@return string? err
function SequenceEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function SequenceEntity:_run_op(ctx, post_done)
  local utility = self._utility
