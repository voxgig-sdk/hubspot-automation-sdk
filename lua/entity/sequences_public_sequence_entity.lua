...
local SequencesPublicSequenceEntity = {}
SequencesPublicSequenceEntity.__index = SequencesPublicSequenceEntity


function SequencesPublicSequenceEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, SequencesPublicSequenceEntity)
  self._name = "sequences_public_sequence"
  self._client = client
...
function SequencesPublicSequenceEntity:get_name()
  return self._name
end


function SequencesPublicSequenceEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return SequencesPublicSequenceEntity.new(self._client, opts)
end
...
function SequencesPublicSequenceEntity:mark_deleted()
  self._deleted = true
end


function SequencesPublicSequenceEntity:deleted()
  return true == self._deleted
end


function SequencesPublicSequenceEntity:data_set(args)
  if args ~= nil then
...
function SequencesPublicSequenceEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function SequencesPublicSequenceEntity:match_set(args)
  if args ~= nil then
...
function SequencesPublicSequenceEntity:match_get()
...
function SequencesPublicSequenceEntity:stream(action, args, callopts)
...
---@param reqmatch SequencesPublicSequenceLoadMatch
---@param ctrl? table
---@return SequencesPublicSequence
---@return string? err
function SequencesPublicSequenceEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function SequencesPublicSequenceEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return SequencesPublicSequenceEntity
