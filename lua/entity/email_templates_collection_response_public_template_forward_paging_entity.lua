-- HubspotAutomation SDK EmailTemplatesCollectionResponsePublicTemplateForwardPaging entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local EmailTemplatesCollectionResponsePublicTemplateForwardPagingEntity = {}
EmailTemplatesCollectionResponsePublicTemplateForwardPagingEntity.__index = EmailTemplatesCollectionResponsePublicTemplateForwardPagingEntity


function EmailTemplatesCollectionResponsePublicTemplateForwardPagingEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, EmailTemplatesCollectionResponsePublicTemplateForwardPagingEntity)
  self._name = "email_templates_collection_response_public_template_forward_paging"
  self._client = client
...
function EmailTemplatesCollectionResponsePublicTemplateForwardPagingEntity:get_name()
  return self._name
end


function EmailTemplatesCollectionResponsePublicTemplateForwardPagingEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return EmailTemplatesCollectionResponsePublicTemplateForwardPagingEntity.new(self._client, opts)
end
...
function EmailTemplatesCollectionResponsePublicTemplateForwardPagingEntity:mark_deleted()
  self._deleted = true
end


function EmailTemplatesCollectionResponsePublicTemplateForwardPagingEntity:deleted()
  return true == self._deleted
end


function EmailTemplatesCollectionResponsePublicTemplateForwardPagingEntity:data_set(args)
  if args ~= nil then
...
function EmailTemplatesCollectionResponsePublicTemplateForwardPagingEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function EmailTemplatesCollectionResponsePublicTemplateForwardPagingEntity:match_set(args)
  if args ~= nil then
...
function EmailTemplatesCollectionResponsePublicTemplateForwardPagingEntity:match_get()
...
function EmailTemplatesCollectionResponsePublicTemplateForwardPagingEntity:stream(action, args, callopts)
...
---@param reqmatch EmailTemplatesCollectionResponsePublicTemplateForwardPagingListMatch
---@param ctrl? table
---@return EmailTemplatesCollectionResponsePublicTemplateForwardPaging[]
---@return string? err
function EmailTemplatesCollectionResponsePublicTemplateForwardPagingEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function EmailTemplatesCollectionResponsePublicTemplateForwardPagingEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return EmailTemplatesCollectionResponsePublicTemplateForwardPagingEntity
