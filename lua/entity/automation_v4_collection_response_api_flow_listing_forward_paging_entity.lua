-- HubspotAutomation SDK AutomationV4CollectionResponseApiFlowListingForwardPaging entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local AutomationV4CollectionResponseApiFlowListingForwardPagingEntity = {}
AutomationV4CollectionResponseApiFlowListingForwardPagingEntity.__index = AutomationV4CollectionResponseApiFlowListingForwardPagingEntity


function AutomationV4CollectionResponseApiFlowListingForwardPagingEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, AutomationV4CollectionResponseApiFlowListingForwardPagingEntity)
  self._name = "automation_v4_collection_response_api_flow_listing_forward_paging"
  self._client = client
...
function AutomationV4CollectionResponseApiFlowListingForwardPagingEntity:get_name()
  return self._name
end


function AutomationV4CollectionResponseApiFlowListingForwardPagingEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return AutomationV4CollectionResponseApiFlowListingForwardPagingEntity.new(self._client, opts)
end
...
function AutomationV4CollectionResponseApiFlowListingForwardPagingEntity:mark_deleted()
  self._deleted = true
end


function AutomationV4CollectionResponseApiFlowListingForwardPagingEntity:deleted()
  return true == self._deleted
end


function AutomationV4CollectionResponseApiFlowListingForwardPagingEntity:data_set(args)
  if args ~= nil then
...
function AutomationV4CollectionResponseApiFlowListingForwardPagingEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function AutomationV4CollectionResponseApiFlowListingForwardPagingEntity:match_set(args)
  if args ~= nil then
...
function AutomationV4CollectionResponseApiFlowListingForwardPagingEntity:match_get()
...
function AutomationV4CollectionResponseApiFlowListingForwardPagingEntity:stream(action, args, callopts)
...
---@param reqmatch AutomationV4CollectionResponseApiFlowListingForwardPagingListMatch
---@param ctrl? table
---@return AutomationV4CollectionResponseApiFlowListingForwardPaging[]
---@return string? err
function AutomationV4CollectionResponseApiFlowListingForwardPagingEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function AutomationV4CollectionResponseApiFlowListingForwardPagingEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return AutomationV4CollectionResponseApiFlowListingForwardPagingEntity
