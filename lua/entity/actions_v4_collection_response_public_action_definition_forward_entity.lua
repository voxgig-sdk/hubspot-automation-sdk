-- HubspotAutomation SDK ActionsV4CollectionResponsePublicActionDefinitionForward entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ActionsV4CollectionResponsePublicActionDefinitionForwardEntity = {}
ActionsV4CollectionResponsePublicActionDefinitionForwardEntity.__index = ActionsV4CollectionResponsePublicActionDefinitionForwardEntity


function ActionsV4CollectionResponsePublicActionDefinitionForwardEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ActionsV4CollectionResponsePublicActionDefinitionForwardEntity)
  self._name = "actions_v4_collection_response_public_action_definition_forward"
  self._client = client
...
function ActionsV4CollectionResponsePublicActionDefinitionForwardEntity:get_name()
  return self._name
end


function ActionsV4CollectionResponsePublicActionDefinitionForwardEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ActionsV4CollectionResponsePublicActionDefinitionForwardEntity.new(self._client, opts)
end
...
function ActionsV4CollectionResponsePublicActionDefinitionForwardEntity:mark_deleted()
  self._deleted = true
end


function ActionsV4CollectionResponsePublicActionDefinitionForwardEntity:deleted()
  return true == self._deleted
end


function ActionsV4CollectionResponsePublicActionDefinitionForwardEntity:data_set(args)
  if args ~= nil then
...
function ActionsV4CollectionResponsePublicActionDefinitionForwardEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ActionsV4CollectionResponsePublicActionDefinitionForwardEntity:match_set(args)
  if args ~= nil then
...
function ActionsV4CollectionResponsePublicActionDefinitionForwardEntity:match_get()
...
function ActionsV4CollectionResponsePublicActionDefinitionForwardEntity:stream(action, args, callopts)
...
---@param reqmatch ActionsV4CollectionResponsePublicActionDefinitionForwardLoadMatch
---@param ctrl? table
---@return ActionsV4CollectionResponsePublicActionDefinitionForward
---@return string? err
function ActionsV4CollectionResponsePublicActionDefinitionForwardEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function ActionsV4CollectionResponsePublicActionDefinitionForwardEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ActionsV4CollectionResponsePublicActionDefinitionForwardEntity
