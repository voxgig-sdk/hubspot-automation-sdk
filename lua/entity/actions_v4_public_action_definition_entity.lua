...
local ActionsV4PublicActionDefinitionEntity = {}
ActionsV4PublicActionDefinitionEntity.__index = ActionsV4PublicActionDefinitionEntity


function ActionsV4PublicActionDefinitionEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ActionsV4PublicActionDefinitionEntity)
  self._name = "actions_v4_public_action_definition"
  self._client = client
...
function ActionsV4PublicActionDefinitionEntity:get_name()
  return self._name
end


function ActionsV4PublicActionDefinitionEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ActionsV4PublicActionDefinitionEntity.new(self._client, opts)
end
...
function ActionsV4PublicActionDefinitionEntity:mark_deleted()
  self._deleted = true
end


function ActionsV4PublicActionDefinitionEntity:deleted()
  return true == self._deleted
end


function ActionsV4PublicActionDefinitionEntity:data_set(args)
  if args ~= nil then
...
function ActionsV4PublicActionDefinitionEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ActionsV4PublicActionDefinitionEntity:match_set(args)
  if args ~= nil then
...
function ActionsV4PublicActionDefinitionEntity:match_get()
...
function ActionsV4PublicActionDefinitionEntity:stream(action, args, callopts)
...
---@param reqmatch ActionsV4PublicActionDefinitionLoadMatch
---@param ctrl? table
---@return ActionsV4PublicActionDefinition
---@return string? err
function ActionsV4PublicActionDefinitionEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata ActionsV4PublicActionDefinitionCreateData
---@param ctrl? table
---@return ActionsV4PublicActionDefinition
---@return string? err
function ActionsV4PublicActionDefinitionEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata ActionsV4PublicActionDefinitionUpdateData
---@param ctrl? table
---@return ActionsV4PublicActionDefinition
---@return string? err
function ActionsV4PublicActionDefinitionEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function ActionsV4PublicActionDefinitionEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ActionsV4PublicActionDefinitionEntity
