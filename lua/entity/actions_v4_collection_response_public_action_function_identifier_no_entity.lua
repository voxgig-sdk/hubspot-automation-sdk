-- HubspotAutomation SDK ActionsV4CollectionResponsePublicActionFunctionIdentifierNo entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ActionsV4CollectionResponsePublicActionFunctionIdentifierNoEntity = {}
ActionsV4CollectionResponsePublicActionFunctionIdentifierNoEntity.__index = ActionsV4CollectionResponsePublicActionFunctionIdentifierNoEntity


function ActionsV4CollectionResponsePublicActionFunctionIdentifierNoEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ActionsV4CollectionResponsePublicActionFunctionIdentifierNoEntity)
  self._name = "actions_v4_collection_response_public_action_function_identifier_no"
  self._client = client
...
function ActionsV4CollectionResponsePublicActionFunctionIdentifierNoEntity:get_name()
  return self._name
end


function ActionsV4CollectionResponsePublicActionFunctionIdentifierNoEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ActionsV4CollectionResponsePublicActionFunctionIdentifierNoEntity.new(self._client, opts)
end
...
function ActionsV4CollectionResponsePublicActionFunctionIdentifierNoEntity:mark_deleted()
  self._deleted = true
end


function ActionsV4CollectionResponsePublicActionFunctionIdentifierNoEntity:deleted()
  return true == self._deleted
end


function ActionsV4CollectionResponsePublicActionFunctionIdentifierNoEntity:data_set(args)
  if args ~= nil then
...
function ActionsV4CollectionResponsePublicActionFunctionIdentifierNoEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ActionsV4CollectionResponsePublicActionFunctionIdentifierNoEntity:match_set(args)
  if args ~= nil then
...
function ActionsV4CollectionResponsePublicActionFunctionIdentifierNoEntity:match_get()
...
function ActionsV4CollectionResponsePublicActionFunctionIdentifierNoEntity:stream(action, args, callopts)
...
---@param reqmatch ActionsV4CollectionResponsePublicActionFunctionIdentifierNoListMatch
---@param ctrl? table
---@return ActionsV4CollectionResponsePublicActionFunctionIdentifierNo[]
---@return string? err
function ActionsV4CollectionResponsePublicActionFunctionIdentifierNoEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function ActionsV4CollectionResponsePublicActionFunctionIdentifierNoEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ActionsV4CollectionResponsePublicActionFunctionIdentifierNoEntity
