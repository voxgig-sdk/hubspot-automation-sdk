-- HubspotAutomation SDK SequencesCollectionResponseWithTotalPublicSequenceLite entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local SequencesCollectionResponseWithTotalPublicSequenceLiteEntity = {}
SequencesCollectionResponseWithTotalPublicSequenceLiteEntity.__index = SequencesCollectionResponseWithTotalPublicSequenceLiteEntity


function SequencesCollectionResponseWithTotalPublicSequenceLiteEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, SequencesCollectionResponseWithTotalPublicSequenceLiteEntity)
  self._name = "sequences_collection_response_with_total_public_sequence_lite"
  self._client = client
...
function SequencesCollectionResponseWithTotalPublicSequenceLiteEntity:get_name()
  return self._name
end


function SequencesCollectionResponseWithTotalPublicSequenceLiteEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return SequencesCollectionResponseWithTotalPublicSequenceLiteEntity.new(self._client, opts)
end
...
function SequencesCollectionResponseWithTotalPublicSequenceLiteEntity:mark_deleted()
  self._deleted = true
end


function SequencesCollectionResponseWithTotalPublicSequenceLiteEntity:deleted()
  return true == self._deleted
end


function SequencesCollectionResponseWithTotalPublicSequenceLiteEntity:data_set(args)
  if args ~= nil then
...
function SequencesCollectionResponseWithTotalPublicSequenceLiteEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function SequencesCollectionResponseWithTotalPublicSequenceLiteEntity:match_set(args)
  if args ~= nil then
...
function SequencesCollectionResponseWithTotalPublicSequenceLiteEntity:match_get()
...
function SequencesCollectionResponseWithTotalPublicSequenceLiteEntity:stream(action, args, callopts)
...
---@param reqmatch SequencesCollectionResponseWithTotalPublicSequenceLiteListMatch
---@param ctrl? table
---@return SequencesCollectionResponseWithTotalPublicSequenceLite[]
---@return string? err
function SequencesCollectionResponseWithTotalPublicSequenceLiteEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function SequencesCollectionResponseWithTotalPublicSequenceLiteEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return SequencesCollectionResponseWithTotalPublicSequenceLiteEntity
