-- HubspotAutomation SDK SequencesPublicSequenceEnrollmentLite entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local SequencesPublicSequenceEnrollmentLiteEntity = {}
SequencesPublicSequenceEnrollmentLiteEntity.__index = SequencesPublicSequenceEnrollmentLiteEntity


function SequencesPublicSequenceEnrollmentLiteEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, SequencesPublicSequenceEnrollmentLiteEntity)
  self._name = "sequences_public_sequence_enrollment_lite"
  self._client = client
...
function SequencesPublicSequenceEnrollmentLiteEntity:get_name()
  return self._name
end


function SequencesPublicSequenceEnrollmentLiteEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return SequencesPublicSequenceEnrollmentLiteEntity.new(self._client, opts)
end
...
function SequencesPublicSequenceEnrollmentLiteEntity:mark_deleted()
  self._deleted = true
end


function SequencesPublicSequenceEnrollmentLiteEntity:deleted()
  return true == self._deleted
end


function SequencesPublicSequenceEnrollmentLiteEntity:data_set(args)
  if args ~= nil then
...
function SequencesPublicSequenceEnrollmentLiteEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function SequencesPublicSequenceEnrollmentLiteEntity:match_set(args)
  if args ~= nil then
...
function SequencesPublicSequenceEnrollmentLiteEntity:match_get()
...
function SequencesPublicSequenceEnrollmentLiteEntity:stream(action, args, callopts)
...
---@param reqdata SequencesPublicSequenceEnrollmentLiteCreateData
---@param ctrl? table
---@return SequencesPublicSequenceEnrollmentLite
---@return string? err
function SequencesPublicSequenceEnrollmentLiteEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function SequencesPublicSequenceEnrollmentLiteEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return SequencesPublicSequenceEnrollmentLiteEntity
