...
function FunctionEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, FunctionEntity)
  self._name = "function"
  self._client = client
...
function FunctionEntity:get_name()
  return self._name
end


function FunctionEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return FunctionEntity.new(self._client, opts)
end
...
function FunctionEntity:mark_deleted()
  self._deleted = true
end


function FunctionEntity:deleted()
  return true == self._deleted
end


function FunctionEntity:data_set(args)
  if args ~= nil then
...
function FunctionEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function FunctionEntity:match_set(args)
  if args ~= nil then
...
function FunctionEntity:match_get()
...
function FunctionEntity:stream(action, args, callopts)
...
---@param reqmatch FunctionRemoveMatch
---@param ctrl? table
---@return Function
---@return string? err
function FunctionEntity:remove(reqmatch, ctrl)
  local utility = self._utility
...
function FunctionEntity:_run_op(ctx, post_done)
  local utility = self._utility
