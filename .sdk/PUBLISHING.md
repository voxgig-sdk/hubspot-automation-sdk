...
|---|---|---|
| `js/` | @voxgig-sdk/hubspot-automation-js | `.github/workflows/publish-js.yml` |
| `ts/` | @voxgig-sdk/hubspot-automation | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/hubspot-automation-js \
      --repository voxgig-sdk/hubspot-automation-sdk \
      --file publish-js.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/hubspot-automation-js` shows it, and
`npm trust revoke @voxgig-sdk/hubspot-automation-js --id=<id>` removes it.
