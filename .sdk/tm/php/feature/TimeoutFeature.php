...
// HubspotAutomation SDK timeout feature
...
class HubspotAutomationTimeoutFeature extends HubspotAutomationBaseFeature
{
    ...
    private function _with_timeout(HubspotAutomationContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(HubspotAutomationContext $_ctx, float $ms): void
    {
        $client = $this->client;
