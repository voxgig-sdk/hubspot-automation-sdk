...
// HubspotAutomation SDK pipeline test
//
...
{
    private static function utility(): HubspotAutomationUtility
    {
        return new HubspotAutomationUtility();
    }
    ...
    private static function ctx(array $over = []): HubspotAutomationContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new HubspotAutomationContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new HubspotAutomationOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof HubspotAutomationError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new HubspotAutomationOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = HubspotAutomationMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new HubspotAutomationOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = HubspotAutomationMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new HubspotAutomationOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = HubspotAutomationMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new HubspotAutomationSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = HubspotAutomationMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new HubspotAutomationResponse([]),
            'result' => new HubspotAutomationResult([]),
        ]);
        [, $err] = HubspotAutomationMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new HubspotAutomationSpec([]),
            'response' => null,
            'result' => new HubspotAutomationResult([]),
        ]);
        [, $err] = HubspotAutomationMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new HubspotAutomationSpec(['step' => 's']),
            'response' => new HubspotAutomationResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new HubspotAutomationResult([]),
        ]);
        [, $err] = HubspotAutomationMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new HubspotAutomationSpec(['step' => 's']),
            'response' => new HubspotAutomationResponse(self::resp(200, ['v' => 1])),
            'result' => new HubspotAutomationResult([]),
        ]);
        [, $err] = HubspotAutomationMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new HubspotAutomationSpec(['step' => 's']),
            'response' => new HubspotAutomationResponse(self::resp(200, ['v' => 2])),
            'result' => new HubspotAutomationResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        HubspotAutomationMakeResponse::call($ctx);
    ...
    {
        $preset = new HubspotAutomationResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new HubspotAutomationSpec([]),
            'response' => new HubspotAutomationResponse([]),
            'result' => new HubspotAutomationResult([]),
        ...
        [$got, $err] = HubspotAutomationMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new HubspotAutomationResult([])]);
        [, $err] = HubspotAutomationMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new HubspotAutomationSpec([]), 'result' => null]);
        [, $err] = HubspotAutomationMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new HubspotAutomationSpec(['step' => 's']),
            'result' => new HubspotAutomationResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new HubspotAutomationOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = HubspotAutomationMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new HubspotAutomationSpec(['step' => 's']),
            'result' => new HubspotAutomationResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new HubspotAutomationOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = HubspotAutomationMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new HubspotAutomationResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new HubspotAutomationSpec([]),
            'result' => new HubspotAutomationResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = HubspotAutomationMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = HubspotAutomationMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new HubspotAutomationError('boom', 'boom');
        $utility->fetcher = function (HubspotAutomationContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new HubspotAutomationSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = HubspotAutomationMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (HubspotAutomationContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = HubspotAutomationMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(HubspotAutomationResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        HubspotAutomationMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (HubspotAutomationContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new HubspotAutomationSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = HubspotAutomationMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new HubspotAutomationResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new HubspotAutomationSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = HubspotAutomationMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = HubspotAutomationMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = HubspotAutomationMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new HubspotAutomationResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, HubspotAutomationDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new HubspotAutomationResult(['ok' => false])]);
        $this->expectException(HubspotAutomationError::class);
        HubspotAutomationDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new HubspotAutomationResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', HubspotAutomationMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        HubspotAutomationMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new HubspotAutomationBaseFeature();
        $b = new HubspotAutomationBaseFeature();
        HubspotAutomationFeatureAdd::call($ctx, $a);
        HubspotAutomationFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): HubspotAutomationBaseFeature
    {
        $f = new HubspotAutomationBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        HubspotAutomationFeatureAdd::call($ctx, self::named_feature('a'));
        HubspotAutomationFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        HubspotAutomationFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        HubspotAutomationFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        HubspotAutomationFeatureAdd::call($ctx, $replace);
        ...
        HubspotAutomationFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): HubspotAutomationContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new HubspotAutomationSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = HubspotAutomationPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        HubspotAutomationPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new HubspotAutomationResponse(['headers' => null]),
            'result' => new HubspotAutomationResult([]),
        ]);
        HubspotAutomationResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        HubspotAutomationResultBody::call($ctx);
