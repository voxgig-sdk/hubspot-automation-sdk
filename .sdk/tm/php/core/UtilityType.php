...
// HubspotAutomation SDK utility type

class HubspotAutomationUtility
{
    ...
    public static function copy(HubspotAutomationUtility $src): HubspotAutomationUtility
    {
        $u = new HubspotAutomationUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
