...
// HubspotAutomation SDK utility: graphql
//
...
class HubspotAutomationGraphql
{
    ...
    // equivalent.
    public static function body(HubspotAutomationContext $ctx): mixed
    {
    ...
    public static function errors(HubspotAutomationContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
