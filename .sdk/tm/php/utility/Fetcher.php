...
// HubspotAutomation SDK utility: fetcher

class HubspotAutomationFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; HubspotAutomationSDK/1.0)';
    ...
    public static function call(HubspotAutomationContext $ctx, string $fullurl, array $fetchdef): array
    {
