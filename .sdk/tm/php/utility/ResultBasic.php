...
// HubspotAutomation SDK utility: result_basic

class HubspotAutomationResultBasic
{
    public static function call(HubspotAutomationContext $ctx): ?HubspotAutomationResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof HubspotAutomationError) ? $result->err->msg : (string)$result->err;
