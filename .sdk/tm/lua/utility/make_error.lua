...
local function make_error_util(ctx, err)
  ...
  local msg = "HubspotAutomationSDK: " .. opname .. ": " .. errmsg
  ...
  local sdk_err = HubspotAutomationError.new("", msg, ctx)
  ...
  if type(err) == "table" and getmetatable(err) == HubspotAutomationError then
