...
describe('EmailTemplatesCollectionResponsePublicTemplateForwardPagingEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    for (const op of ['list']) {
      if (!live && maybeSkipControl(t, 'entityOp', 'email_templates_collection_response_public_template_forward_paging.' + op, live)) return
    }
    ...
    let email_templates_collection_response_public_template_forward_paging_ref01_data = Object.values(setup.data.existing.email_templates_collection_response_public_template_forward_paging)[0] as any
    ...
    const email_templates_collection_response_public_template_forward_paging_ref01_match: any = {}

    const email_templates_collection_response_public_template_forward_paging_ref01_list = (await email_templates_collection_response_public_template_forward_paging_ref01_ent.list(email_templates_collection_response_public_template_forward_paging_ref01_match)).map((e: any) => e.data())
