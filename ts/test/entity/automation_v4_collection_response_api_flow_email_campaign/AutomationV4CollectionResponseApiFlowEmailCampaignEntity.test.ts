...
describe('AutomationV4CollectionResponseApiFlowEmailCampaignEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    for (const op of ['list']) {
      if (!live && maybeSkipControl(t, 'entityOp', 'automation_v4_collection_response_api_flow_email_campaign.' + op, live)) return
    }
    ...
    let automation_v4_collection_response_api_flow_email_campaign_ref01_data = Object.values(setup.data.existing.automation_v4_collection_response_api_flow_email_campaign)[0] as any
    ...
    const automation_v4_collection_response_api_flow_email_campaign_ref01_match: any = {}

    const automation_v4_collection_response_api_flow_email_campaign_ref01_list = (await automation_v4_collection_response_api_flow_email_campaign_ref01_ent.list(automation_v4_collection_response_api_flow_email_campaign_ref01_match)).map((e: any) => e.data())
