...
describe('ActionsV4CollectionResponsePublicActionFunctionIdentifierNoEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    for (const op of ['list']) {
      if (!live && maybeSkipControl(t, 'entityOp', 'actions_v4_collection_response_public_action_function_identifier_no.' + op, live)) return
    }
    ...
    let actions_v4_collection_response_public_action_function_identifier_no_ref01_data = Object.values(setup.data.existing.actions_v4_collection_response_public_action_function_identifier_no)[0] as any
    ...
    const actions_v4_collection_response_public_action_function_identifier_no_ref01_match: any = {}
    ...
    const actions_v4_collection_response_public_action_function_identifier_no_ref01_list = (await actions_v4_collection_response_public_action_function_identifier_no_ref01_ent.list(actions_v4_collection_response_public_action_function_identifier_no_ref01_match)).map((e: any) => e.data())
