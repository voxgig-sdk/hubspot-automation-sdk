...
describe('AutomationV4CollectionResponseApiHistogramDataPointNoEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    for (const op of ['load']) {
      if (!live && maybeSkipControl(t, 'entityOp', 'automation_v4_collection_response_api_histogram_data_point_no.' + op, live)) return
    }
    ...
    let automation_v4_collection_response_api_histogram_data_point_no_ref01_data = Object.values(setup.data.existing.automation_v4_collection_response_api_histogram_data_point_no)[0] as any
