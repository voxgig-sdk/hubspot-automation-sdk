...
class BasicEntity extends HubspotAutomationEntityBase<Basic> {
  ...
  async remove(
    this: any, reqmatch?: BasicRemoveMatch, ctrl?: Control,
  ): Promise<BasicEntity> {
    ...
    try {
      ...
      if (err) {
        ...
        // Promise<BasicEntity> return stays clean under strict null checks.
