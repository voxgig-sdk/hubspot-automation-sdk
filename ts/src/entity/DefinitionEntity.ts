...
import type {
  ...
  DefinitionRemoveMatch,
} from '../HubspotAutomationTypes'

// TODO: needs Entity superclass
class DefinitionEntity extends HubspotAutomationEntityBase<Definition> {

  constructor(client: HubspotAutomationSDK, entopts: any) {
    super(client, entopts)
    this.name = 'definition'
    this.name_ = 'definition'
    this.Name = 'Definition'
  }


  make(this: DefinitionEntity) {
    return new DefinitionEntity(this._client, this.entopts())
  }
  ...
  async create(this: any, reqdata?: DefinitionCreateData, ctrl?: Control): Promise<DefinitionEntity> {
    ...
    try {
      ...
      if (err) {
        ...
        // Promise<Definition> return stays clean under strict null checks.
  ...
  async remove(
    this: any, reqmatch?: DefinitionRemoveMatch, ctrl?: Control,
    ...
    try {
      ...
      if (err) {
        ...
        // Off-happy-path (throw disabled): typed as any so the method's
        // Promise<DefinitionEntity> return stays clean under strict null checks.
        return undefined as any
      }
    }
  }
