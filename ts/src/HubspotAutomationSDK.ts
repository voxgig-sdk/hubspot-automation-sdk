...
class HubspotAutomationSDK {
  ...
  async graphql(query: string, variables?: any, ctrl?: any) {
    ...
    if (null != errors && Array.isArray(errors) && 0 < errors.length) {
      ...
      const err: any = new Error('HubspotAutomationSDK: graphql: ' +
  ...
  ActionsV4CollectionResponsePublicActionDefinitionForward(entopts?: Record<string, any>) {
    const self = this
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  ActionsV4CollectionResponsePublicActionFunctionIdentifierNo(entopts?: Record<string, any>) {
    const self = this
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  ActionsV4CollectionResponsePublicActionRevisionForward(entopts?: Record<string, any>) {
    const self = this
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  ActionsV4PublicActionDefinition(entopts?: Record<string, any>) {
    const self = this
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  ActionsV4PublicActionDefinitionRequiresObject(entopts?: Record<string, any>) {
    const self = this
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  ActionsV4PublicActionFunction(entopts?: Record<string, any>) {
    const self = this
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  ActionsV4PublicActionFunctionIdentifier(entopts?: Record<string, any>) {
    const self = this
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  ActionsV4PublicActionRevision(entopts?: Record<string, any>) {
    const self = this
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  AutomationV4ApiFlow(entopts?: Record<string, any>) {
    const self = this
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  AutomationV4BatchResponseApiFlow(entopts?: Record<string, any>) {
    const self = this
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  AutomationV4BatchResponseFlowIdWorkflowIdMapping(entopts?: Record<string, any>) {
    const self = this
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  AutomationV4CollectionResponseApiFlowEmailCampaign(entopts?: Record<string, any>) {
    const self = this
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  AutomationV4CollectionResponseApiFlowListingForwardPaging(entopts?: Record<string, any>) {
    const self = this
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  AutomationV4CollectionResponseApiHistogramDataPointNo(entopts?: Record<string, any>) {
    const self = this
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  EmailTemplatesCollectionResponsePublicFolderForwardPaging(entopts?: Record<string, any>) {
    const self = this
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  EmailTemplatesCollectionResponsePublicTemplateForwardPaging(entopts?: Record<string, any>) {
    const self = this
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  EmailTemplatesPublicTemplate(entopts?: Record<string, any>) {
    const self = this
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  Sequence(entopts?: Record<string, any>) {
    const self = this
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  SequencesCollectionResponseWithTotalPublicSequenceLite(entopts?: Record<string, any>) {
    const self = this
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  SequencesPublicSequence(entopts?: Record<string, any>) {
    const self = this
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  SequencesPublicSequenceEnrollment(entopts?: Record<string, any>) {
    const self = this
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  SequencesPublicSequenceEnrollmentLite(entopts?: Record<string, any>) {
    const self = this
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  SequencesPublicSequencePerformance(entopts?: Record<string, any>) {
    const self = this
