...
const __1 = require("..");
const SDK_NAME = 'HubspotAutomationSDK';
...
const TEST_SEED = { "entity": { "actions_v4_collection_response_public_action_definition_forward": { "test01": { "id": "test01" } }, "actions_v4_collection_response_public_action_function_identifier_no": { "test01": { "id": "test01" } }, "actions_v4_collection_response_public_action_revision_forward": { "test01": { "id": "test01" } }, "actions_v4_public_action_definition": { "test01": { "id": "test01" } }, "actions_v4_public_action_definition_requires_object": { "test01": { "id": "test01" } }, "actions_v4_public_action_function": { "test01": { "id": "test01" } }, "actions_v4_public_action_function_identifier": { "test01": { "id": "test01" } }, "actions_v4_public_action_revision": { "test01": { "id": "test01" } }, "automation_v4_api_flow": { "test01": { "id": "test01" } }, "automation_v4_batch_response_api_flow": { "test01": { "id": "test01" } }, "automation_v4_batch_response_flow_id_workflow_id_mapping": { "test01": { "id": "test01" } }, "automation_v4_collection_response_api_flow_email_campaign": { "test01": { "id": "test01" } }, "automation_v4_collection_response_api_flow_listing_forward_paging": { "test01": { "id": "test01" } }, "automation_v4_collection_response_api_histogram_data_point_no": { "test01": { "id": "test01" } }, "basic": { "test01": { "id": "test01" } }, "callback": { "test01": { "id": "test01" } }, "definition": { "test01": { "id": "test01" } }, "email_templates_collection_response_public_folder_forward_paging": { "test01": { "id": "test01" } }, "email_templates_collection_response_public_template_forward_paging": { "test01": { "id": "test01" } }, "email_templates_public_template": { "test01": { "id": "test01" } }, "function": { "test01": { "id": "test01" } }, "sequence": { "test01": { "id": "test01" } }, "sequences_collection_response_with_total_public_sequence_lite": { "test01": { "id": "test01" } }, "sequences_public_sequence": { "test01": { "id": "test01" } }, "sequences_public_sequence_enrollment": { "test01": { "id": "test01" } }, "sequences_public_sequence_enrollment_lite": { "test01": { "id": "test01" } }, "sequences_public_sequence_performance": { "test01": { "id": "test01" } } } };
...
function isRunnable(code) {
    return (/new\s+HubspotAutomationSDK\b/.test(code) ||
        /\bHubspotAutomationSDK\.test\b/.test(code) ||
        /\bclient\s*\./.test(code));
}
...
function rewriteForRun(code) {
    ...
    out = out.replace(/new\s+HubspotAutomationSDK\s*\([^)]*\)/g, () => SEEDED_CTOR);
    out = out.replace(/HubspotAutomationSDK\.test\s*\([^)]*\)/g, () => SEEDED_CTOR);
