...
(0, node_test_1.describe)('ActionsV4CollectionResponsePublicActionRevisionForwardDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-actions_v4_collection_response_public_action_revision_forward', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-actions_v4_collection_response_public_action_revision_forward', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['HUBSPOT_AUTOMATION_TEST_ACTIONS_V4_COLLECTION_RESPONSE_PUBLIC_ACTION_REVISION_FORWARD_ENTID'];
...
//# sourceMappingURL=ActionsV4CollectionResponsePublicActionRevisionForwardDirect.test.js.map