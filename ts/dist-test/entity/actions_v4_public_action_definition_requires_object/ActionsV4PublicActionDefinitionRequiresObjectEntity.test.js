...
(0, node_test_1.describe)('ActionsV4PublicActionDefinitionRequiresObjectEntity', async () => {
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/actions_v4_public_action_definition_requires_object/ActionsV4PublicActionDefinitionRequiresObjectTestData.json');
    ...
    let idmap = transform(['actions_v4_public_action_definition_requires_object01', 'actions_v4_public_action_definition_requires_object02', 'actions_v4_public_action_definition_requires_object03', '2026_0901', '2026_0902', '2026_0903'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=ActionsV4PublicActionDefinitionRequiresObjectEntity.test.js.map