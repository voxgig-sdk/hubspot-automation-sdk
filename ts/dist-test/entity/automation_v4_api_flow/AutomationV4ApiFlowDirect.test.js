...
(0, node_test_1.describe)('AutomationV4ApiFlowDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-automation_v4_api_flow', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-automation_v4_api_flow', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['HUBSPOT_AUTOMATION_TEST_AUTOMATION_V4_API_FLOW_ENTID'];
...
//# sourceMappingURL=AutomationV4ApiFlowDirect.test.js.map