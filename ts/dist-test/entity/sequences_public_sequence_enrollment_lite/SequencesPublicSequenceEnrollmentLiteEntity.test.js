...
(0, node_test_1.describe)('SequencesPublicSequenceEnrollmentLiteEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        (0, node_assert_1.default)(null != sequences_public_sequence_enrollment_lite_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/sequences_public_sequence_enrollment_lite/SequencesPublicSequenceEnrollmentLiteTestData.json');
    ...
    let idmap = transform(['sequences_public_sequence_enrollment_lite01', 'sequences_public_sequence_enrollment_lite02', 'sequences_public_sequence_enrollment_lite03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=SequencesPublicSequenceEnrollmentLiteEntity.test.js.map