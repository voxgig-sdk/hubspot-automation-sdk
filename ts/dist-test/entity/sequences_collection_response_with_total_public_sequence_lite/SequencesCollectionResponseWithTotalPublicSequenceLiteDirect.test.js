...
(0, node_test_1.describe)('SequencesCollectionResponseWithTotalPublicSequenceLiteDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-sequences_collection_response_with_total_public_sequence_lite', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-sequences_collection_response_with_total_public_sequence_lite', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['HUBSPOT_AUTOMATION_TEST_SEQUENCES_COLLECTION_RESPONSE_WITH_TOTAL_PUBLIC_SEQUENCE_LITE_ENTID'];
...
//# sourceMappingURL=SequencesCollectionResponseWithTotalPublicSequenceLiteDirect.test.js.map