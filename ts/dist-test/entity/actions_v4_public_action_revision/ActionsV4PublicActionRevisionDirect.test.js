...
(0, node_test_1.describe)('ActionsV4PublicActionRevisionDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-actions_v4_public_action_revision', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-actions_v4_public_action_revision', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["app_id01", "definition_id01", "id01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['HUBSPOT_AUTOMATION_TEST_ACTIONS_V4_PUBLIC_ACTION_REVISION_ENTID'];
...
//# sourceMappingURL=ActionsV4PublicActionRevisionDirect.test.js.map