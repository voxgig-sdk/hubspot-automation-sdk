...
(0, node_test_1.describe)('SequencesPublicSequencePerformanceDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-sequences_public_sequence_performance', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-sequences_public_sequence_performance', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["sequence01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['HUBSPOT_AUTOMATION_TEST_SEQUENCES_PUBLIC_SEQUENCE_PERFORMANCE_ENTID'];
...
//# sourceMappingURL=SequencesPublicSequencePerformanceDirect.test.js.map