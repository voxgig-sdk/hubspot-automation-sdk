...
(0, node_test_1.describe)('ActionsV4CollectionResponsePublicActionDefinitionForwardDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-actions_v4_collection_response_public_action_definition_forward', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-actions_v4_collection_response_public_action_definition_forward', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["app_id01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['HUBSPOT_AUTOMATION_TEST_ACTIONS_V4_COLLECTION_RESPONSE_PUBLIC_ACTION_DEFINITION_FORWARD_ENTID'];
...
//# sourceMappingURL=ActionsV4CollectionResponsePublicActionDefinitionForwardDirect.test.js.map