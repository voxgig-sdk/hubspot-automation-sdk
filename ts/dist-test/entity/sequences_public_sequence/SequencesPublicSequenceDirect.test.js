...
(0, node_test_1.describe)('SequencesPublicSequenceDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-sequences_public_sequence', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-sequences_public_sequence', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["sequence_id01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['HUBSPOT_AUTOMATION_TEST_SEQUENCES_PUBLIC_SEQUENCE_ENTID'];
...
//# sourceMappingURL=SequencesPublicSequenceDirect.test.js.map