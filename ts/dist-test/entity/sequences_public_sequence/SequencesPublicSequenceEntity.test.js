...
(0, node_test_1.describe)('SequencesPublicSequenceEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if (!live && (0, utility_1.maybeSkipControl)(t, 'entityOp', 'sequences_public_sequence.' + op, live))
                return;
        }
        ...
        let sequences_public_sequence_ref01_data = Object.values(setup.data.existing.sequences_public_sequence)[0];
        // LOAD
        const sequences_public_sequence_ref01_ent = client.SequencesPublicSequence();
        const sequences_public_sequence_ref01_match_dt0 = {};
        ...
        (0, node_assert_1.default)(sequences_public_sequence_ref01_data_dt0.id === sequences_public_sequence_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/sequences_public_sequence/SequencesPublicSequenceTestData.json');
    ...
    let idmap = transform(['sequences_public_sequence01', 'sequences_public_sequence02', 'sequences_public_sequence03', '2026_0901', '2026_0902', '2026_0903'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=SequencesPublicSequenceEntity.test.js.map