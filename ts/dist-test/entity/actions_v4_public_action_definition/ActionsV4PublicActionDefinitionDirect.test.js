...
(0, node_test_1.describe)('ActionsV4PublicActionDefinitionDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-actions_v4_public_action_definition', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-actions_v4_public_action_definition', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['HUBSPOT_AUTOMATION_TEST_ACTIONS_V4_PUBLIC_ACTION_DEFINITION_ENTID'];
...
//# sourceMappingURL=ActionsV4PublicActionDefinitionDirect.test.js.map