...
function basicSetup(extra) {
    ...
    let idmap = transform(['basic01', 'basic02', 'basic03', 'sequence01', 'sequence02', 'sequence03', 'flow01', 'flow02', 'flow03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
