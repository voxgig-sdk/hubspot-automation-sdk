...
(0, node_test_1.describe)('EmailTemplatesCollectionResponsePublicFolderForwardPagingDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-email_templates_collection_response_public_folder_forward_paging', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-email_templates_collection_response_public_folder_forward_paging', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['HUBSPOT_AUTOMATION_TEST_EMAIL_TEMPLATES_COLLECTION_RESPONSE_PUBLIC_FOLDER_FORWARD_PAGING_ENTID'];
...
//# sourceMappingURL=EmailTemplatesCollectionResponsePublicFolderForwardPagingDirect.test.js.map