...
(0, node_test_1.describe)('EmailTemplatesCollectionResponsePublicFolderForwardPagingEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        const email_templates_collection_response_public_folder_forward_paging_ref01_match = {};
        const email_templates_collection_response_public_folder_forward_paging_ref01_list = (await email_templates_collection_response_public_folder_forward_paging_ref01_ent.list(email_templates_collection_response_public_folder_forward_paging_ref01_match)).map((e) => e.data());
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/email_templates_collection_response_public_folder_forward_paging/EmailTemplatesCollectionResponsePublicFolderForwardPagingTestData.json');
    ...
    let idmap = transform(['email_templates_collection_response_public_folder_forward_paging01', 'email_templates_collection_response_public_folder_forward_paging02', 'email_templates_collection_response_public_folder_forward_paging03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=EmailTemplatesCollectionResponsePublicFolderForwardPagingEntity.test.js.map