...
(0, node_test_1.describe)('EmailTemplatesCollectionResponsePublicTemplateForwardPagingEntity', async () => {
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/email_templates_collection_response_public_template_forward_paging/EmailTemplatesCollectionResponsePublicTemplateForwardPagingTestData.json');
    ...
    let idmap = transform(['email_templates_collection_response_public_template_forward_paging01', 'email_templates_collection_response_public_template_forward_paging02', 'email_templates_collection_response_public_template_forward_paging03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=EmailTemplatesCollectionResponsePublicTemplateForwardPagingEntity.test.js.map