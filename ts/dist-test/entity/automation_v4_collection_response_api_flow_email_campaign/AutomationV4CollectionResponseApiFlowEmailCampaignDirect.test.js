...
(0, node_test_1.describe)('AutomationV4CollectionResponseApiFlowEmailCampaignDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-automation_v4_collection_response_api_flow_email_campaign', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-automation_v4_collection_response_api_flow_email_campaign', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['HUBSPOT_AUTOMATION_TEST_AUTOMATION_V4_COLLECTION_RESPONSE_API_FLOW_EMAIL_CAMPAIGN_ENTID'];
...
//# sourceMappingURL=AutomationV4CollectionResponseApiFlowEmailCampaignDirect.test.js.map