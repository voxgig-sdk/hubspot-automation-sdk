...
(0, node_test_1.describe)('SequencesPublicSequenceEnrollmentEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        (0, node_assert_1.default)(sequences_public_sequence_enrollment_ref01_data_dt0.id === sequences_public_sequence_enrollment_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/sequences_public_sequence_enrollment/SequencesPublicSequenceEnrollmentTestData.json');
    ...
    let idmap = transform(['sequences_public_sequence_enrollment01', 'sequences_public_sequence_enrollment02', 'sequences_public_sequence_enrollment03', 'contact01', 'contact02', 'contact03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=SequencesPublicSequenceEnrollmentEntity.test.js.map