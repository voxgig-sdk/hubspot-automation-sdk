...
(0, node_test_1.describe)('AutomationV4CollectionResponseApiFlowListingForwardPagingEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['list']) {
            if (!live && (0, utility_1.maybeSkipControl)(t, 'entityOp', 'automation_v4_collection_response_api_flow_listing_forward_paging.' + op, live))
                return;
        }
        ...
        let automation_v4_collection_response_api_flow_listing_forward_paging_ref01_data = Object.values(setup.data.existing.automation_v4_collection_response_api_flow_listing_forward_paging)[0];
        // LIST
        ...
        const automation_v4_collection_response_api_flow_listing_forward_paging_ref01_match = {};
        const automation_v4_collection_response_api_flow_listing_forward_paging_ref01_list = (await automation_v4_collection_response_api_flow_listing_forward_paging_ref01_ent.list(automation_v4_collection_response_api_flow_listing_forward_paging_ref01_match)).map((e) => e.data());
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/automation_v4_collection_response_api_flow_listing_forward_paging/AutomationV4CollectionResponseApiFlowListingForwardPagingTestData.json');
    ...
    let idmap = transform(['automation_v4_collection_response_api_flow_listing_forward_paging01', 'automation_v4_collection_response_api_flow_listing_forward_paging02', 'automation_v4_collection_response_api_flow_listing_forward_paging03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=AutomationV4CollectionResponseApiFlowListingForwardPagingEntity.test.js.map