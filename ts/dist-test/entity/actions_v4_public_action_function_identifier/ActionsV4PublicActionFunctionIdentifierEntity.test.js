...
(0, node_test_1.describe)('ActionsV4PublicActionFunctionIdentifierEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        actions_v4_public_action_function_identifier_ref01_data_up0[actions_v4_public_action_function_identifier_ref01_markdef_up0.name] = actions_v4_public_action_function_identifier_ref01_markdef_up0.value;
        ...
        (0, node_assert_1.default)(actions_v4_public_action_function_identifier_ref01_resdata_up0.id === actions_v4_public_action_function_identifier_ref01_data_up0.id);
        (0, node_assert_1.default)(actions_v4_public_action_function_identifier_ref01_resdata_up0[actions_v4_public_action_function_identifier_ref01_markdef_up0.name] === actions_v4_public_action_function_identifier_ref01_markdef_up0.value);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/actions_v4_public_action_function_identifier/ActionsV4PublicActionFunctionIdentifierTestData.json');
    ...
    let idmap = transform(['actions_v4_public_action_function_identifier01', 'actions_v4_public_action_function_identifier02', 'actions_v4_public_action_function_identifier03', '2026_0901', '2026_0902', '2026_0903', 'function01', 'function02', 'function03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=ActionsV4PublicActionFunctionIdentifierEntity.test.js.map