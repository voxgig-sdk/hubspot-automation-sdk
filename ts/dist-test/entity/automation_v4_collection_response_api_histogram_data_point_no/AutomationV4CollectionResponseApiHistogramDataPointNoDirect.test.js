...
(0, node_test_1.describe)('AutomationV4CollectionResponseApiHistogramDataPointNoDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.HubspotAutomationSDK({
    ...
    (0, node_test_1.test)('direct-load-automation_v4_collection_response_api_histogram_data_point_no', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-automation_v4_collection_response_api_histogram_data_point_no', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["flow_id01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.HubspotAutomationSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
            apikey: env.HUBSPOT_AUTOMATION_APIKEY,
        }));
        let idmap = env['HUBSPOT_AUTOMATION_TEST_AUTOMATION_V4_COLLECTION_RESPONSE_API_HISTOGRAM_DATA_POINT_NO_ENTID'];
    ...
    const client = new __1.HubspotAutomationSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=AutomationV4CollectionResponseApiHistogramDataPointNoDirect.test.js.map