...
(0, node_test_1.describe)('ActionsV4CollectionResponsePublicActionFunctionIdentifierNoEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['list']) {
            if (!live && (0, utility_1.maybeSkipControl)(t, 'entityOp', 'actions_v4_collection_response_public_action_function_identifier_no.' + op, live))
                return;
        }
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/actions_v4_collection_response_public_action_function_identifier_no/ActionsV4CollectionResponsePublicActionFunctionIdentifierNoTestData.json');
    ...
    let idmap = transform(['actions_v4_collection_response_public_action_function_identifier_no01', 'actions_v4_collection_response_public_action_function_identifier_no02', 'actions_v4_collection_response_public_action_function_identifier_no03', '2026_0901', '2026_0902', '2026_0903'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=ActionsV4CollectionResponsePublicActionFunctionIdentifierNoEntity.test.js.map