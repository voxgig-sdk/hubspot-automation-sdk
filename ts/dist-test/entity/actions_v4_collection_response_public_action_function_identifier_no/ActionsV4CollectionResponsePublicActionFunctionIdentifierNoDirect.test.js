...
(0, node_test_1.describe)('ActionsV4CollectionResponsePublicActionFunctionIdentifierNoDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-actions_v4_collection_response_public_action_function_identifier_no', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-actions_v4_collection_response_public_action_function_identifier_no', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["app01", "definition01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['HUBSPOT_AUTOMATION_TEST_ACTIONS_V4_COLLECTION_RESPONSE_PUBLIC_ACTION_FUNCTION_IDENTIFIER_NO_ENTID'];
...
//# sourceMappingURL=ActionsV4CollectionResponsePublicActionFunctionIdentifierNoDirect.test.js.map