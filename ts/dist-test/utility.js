...
function envOverride(m) {
    if ('TRUE' === process.env.HUBSPOT_AUTOMATION_TEST_LIVE ||
        'TRUE' === process.env.HUBSPOT_AUTOMATION_TEST_OVERRIDE) {
    ...
    m.HUBSPOT_AUTOMATION_TEST_EXPLAIN = process.env.HUBSPOT_AUTOMATION_TEST_EXPLAIN || m.HUBSPOT_AUTOMATION_TEST_EXPLAIN;
    return m;
}
