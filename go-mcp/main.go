// Command HubspotAutomation-mcp is an MCP server exposing the HubspotAutomation
// SDK as MCP tools.
//
// Two tools are registered:
//
//	HubspotAutomation_list  — list records of an entity
//	HubspotAutomation_load  — load a single record of an entity
//
